...
/// </summary>
public sealed class ImportedHumanoidCoupledBoneModel
{
    ...
    public bool IsValid
        => Muscles.Length > 0
        && Muscles.Length <= ImportedHumanoidMuscleMap.OrderedMuscleEntries.Count
    ...
    public void Evaluate(
        ...
        float engineUnitsPerSourceMeter,
        ...
        out Vector3 positionDelta)
    {
        ...
        for (int i = 0; i < Muscles.Length; i++)
        {
            ...
            endpointRotation = Quaternion.Normalize(
                endpointRotation * ImportedHumanoidMuscleResponse.ScaleShortestRotation(endpoint, MathF.Abs(amount)));
        ...
        positionDelta = (endpointPosition + positionResidual) * engineUnitsPerSourceMeter;
    }
