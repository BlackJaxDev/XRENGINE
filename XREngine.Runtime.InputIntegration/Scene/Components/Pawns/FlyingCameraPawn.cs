...
namespace XREngine.Components
{
    ...
    [XRTypeRedirect("XREngine.Components.FlyingCameraPawnComponent")]
    public class FlyingCameraPawnComponent : FlyingCameraPawnBaseComponent
    {
        ...
        protected override void MouseMove(float x, float y)
        {
            ...
            {
                float now = (float)RuntimeRenderingHostServices.Current.ElapsedTime;
        ...
        protected override void Tick()
        {
            ...
            float delta = (float)RuntimeRenderingHostServices.Current.UpdateDeltaSeconds;
...
/*
                float nowMove = (float)RuntimeRenderingHostServices.Current.ElapsedTime;
...
*/
        ...
        private void LogCameraMotion(string mode, Vector3 before, Vector3 after)
        {
            ...
            Debug.Out($"[CameraInput] mode={mode} delta={(float)RuntimeRenderingHostServices.Current.UpdateDeltaSeconds:0.####} inc=({_incRight:0.###},{_incUp:0.###},{_incForward:0.###}) pos=({before.X:0.###},{before.Y:0.###},{before.Z:0.###})->({after.X:0.###},{after.Y:0.###},{after.Z:0.###}) basis right={tfm.LocalRight} up={tfm.LocalUp} forward={tfm.LocalForward}");
            _lastMoveTickLogTime = now;
        }
