...
namespace XREngine.Components
{
    public abstract class HeightScaleBaseComponent : XRComponent, IRuntimeVrHeightScaleComponent
    {
        ...
        public void MeasureAvatarHeight()
        {
            ...
            Debug.Animation($"Calculated model height as {height} meters.");
        }
        ...
        protected void UpdateHeightScale()
        {
            ...
            if (movement is not null)
            {
                ...
                halfHeight = movement.HalfHeight;
            }

            //Move the foot halfway down the capsule
            if (footTfm is not null)
            {
                Vector3 translation = new(0.0f, -halfHeight, 0.0f);
            ...
            Vector3 scale = new(ModelToRealWorldHeightRatio);
