...
namespace XREngine.Components.Scene.Mesh
{
    ...
    public class SkyboxComponent : XRComponent, IRenderable
    {
        ...
        private static void ApplyEffectiveAmbient(IRuntimeAmbientSettings settings, Vector3 ambient)
        {
            ambient = new Vector3(
        ...
        private static void SetAmbientIfChanged(IRuntimeAmbientSettings settings, ColorF3 color, float intensity)
        {
...
";
        ...
        /// <summary>
        /// Stereo variant of the skybox vertex shader; keeps reconstructed sky rays eye-local in multiview passes.
        /// </summary>
        private const string StereoVertexShaderSource = @"
#version 450
