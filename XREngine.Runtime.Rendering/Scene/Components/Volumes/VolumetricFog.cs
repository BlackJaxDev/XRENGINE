...
namespace XREngine.Components.Scene.Volumes
{
    ...
    public class VolumetricFogVolumeComponent : XRComponent
    {
        ...
        {
            private static readonly Dictionary<IRuntimeRenderWorld, List<VolumetricFogVolumeComponent>> s_perWorld = new();
            private static readonly object s_lock = new();

            public static void Register(IRuntimeRenderWorld world, VolumetricFogVolumeComponent component)
            {
                lock (s_lock)
                {
            ...
            public static void Unregister(IRuntimeRenderWorld world, VolumetricFogVolumeComponent component)
            {
                lock (s_lock)
                {
                    if (!s_perWorld.TryGetValue(world, out var list))
            ...
            public static int CopyActive(IRuntimeRenderWorld world, Span<VolumetricFogVolumeComponent?> destination)
            {
                destination.Clear();
