...
namespace XREngine.Rendering.UI
{
    ...
    public class UIBoundableTransform : UITransform
    {
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.CreateLocalMatrix");
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.OnResizeActual");
        ...
        public float GetWidth()
        {
            ...
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.GetWidth");
        ...
        public float GetHeight()
        {
            ...
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.GetHeight");
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.GetMaxChildWidth");
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.GetMaxChildHeight");
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.OnLocalMatrixChanged");
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.OnWorldMatrixChanged");
        ...
        protected override void RenderDebug()
        {
            ...
            if (!RuntimeEngine.EditorPreferences.Debug.RenderMesh2DBounds || RuntimeEngine.Rendering.State.IsShadowPass)
                return;
            
            var region = AxisAlignedRegion;
            ColorF4 color = RuntimeEngine.EditorPreferences.Theme.Bounds2DColor;

            RuntimeEngine.Rendering.Debug.RenderLine(
                new Vector3(region.TopLeft, 0.0f) + RuntimeEngine.Rendering.Debug.UIPositionBias,
                new Vector3(region.TopRight, 0.0f) + RuntimeEngine.Rendering.Debug.UIPositionBias,
                color);

            RuntimeEngine.Rendering.Debug.RenderLine(
                new Vector3(region.TopRight, 0.0f) + RuntimeEngine.Rendering.Debug.UIPositionBias,
                new Vector3(region.BottomRight, 0.0f) + RuntimeEngine.Rendering.Debug.UIPositionBias,
                color);

            RuntimeEngine.Rendering.Debug.RenderLine(
                new Vector3(region.BottomRight, 0.0f) + RuntimeEngine.Rendering.Debug.UIPositionBias,
                new Vector3(region.BottomLeft, 0.0f) + RuntimeEngine.Rendering.Debug.UIPositionBias,
                color);
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.RemakeAxisAlignedRegion");
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.FindDeepestComponent");
        ...
        {
            using var profiler = RuntimeEngine.Profiler.Start("UIBoundableTransform.FindAllIntersecting");
