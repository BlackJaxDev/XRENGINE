...
namespace XREngine.Rendering.UI
{
    ...
    public partial class UIVideoComponent : UIMaterialComponent
    {
        ...
        /// </summary>
        private IAudioPlaybackSource? _primaryAudioSource;
        ...
        private static long GetEngineTimeTicks()
            => RuntimeEngine.ElapsedTicks * TimeSpan.TicksPerSecond / System.Diagnostics.Stopwatch.Frequency;
        ...
        private static AbstractRenderer? GetActiveRenderer()
            => AbstractRenderer.Current is not null
                ...
                : RuntimeEngine.Windows.Select(window => window.Renderer).FirstOrDefault();
    }
}
