...
public unsafe partial class VulkanRenderer
{
    ...
    {
        private readonly struct EngineUniformBuffer(Silk.NET.Vulkan.Buffer buffer, DeviceMemory memory, uint size, void* mappedPtr, ulong offset = 0, bool ownsBuffer = true)
        {
