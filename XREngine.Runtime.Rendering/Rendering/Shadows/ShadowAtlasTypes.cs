...
public readonly record struct ShadowAtlasSolveDiagnostics(
    double ElapsedMilliseconds,
    int ClassifiedRequestCount,
    int DirectionalRequestCount,
    int SpotRequestCount,
    int PointRequestCount,
    int DepthRequestCount,
    int Variance2RequestCount,
    int ExponentialVariance2RequestCount,
    int ExponentialVariance4RequestCount,
    int BalancedSolveAttemptCount,
    int FailedCandidateCount,
    int DemotionCount,
    int StickyDemotionCount,
    int DirectionalGroupDemotionCount,
    int DeterministicFallbackDemotionCount,
    int PriorReserveHitCount,
    int PriorReserveMissCount,
    int PriorSubBlockHitCount,
    int PriorSubBlockMissCount,
    int PageAllocationAttemptCount,
    int PageAllocationSuccessCount,
    int PageCreateAttemptCount,
    int PageCreateSuccessCount,
    int PageClearCount,
    int DirectionalGroupSeedCount,
    int DirectionalGroupMemberCount,
    int DirectionalGroupCoLocationFailureCount,
