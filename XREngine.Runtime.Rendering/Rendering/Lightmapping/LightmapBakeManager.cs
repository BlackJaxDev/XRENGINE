...
public sealed class LightmapBakeManager(IRuntimeRenderWorld world) : XRBase
{
    private readonly IRuntimeRenderWorld _world = world;
...
";
    ...
    private static List<LightmapBakeTarget> CollectStaticTargets(IRuntimeRenderWorld world, LightmapBakeRequest request)
    {
    ...
    private static IEnumerable<LightComponent> EnumerateLights(IRuntimeRenderWorld world)
    {
