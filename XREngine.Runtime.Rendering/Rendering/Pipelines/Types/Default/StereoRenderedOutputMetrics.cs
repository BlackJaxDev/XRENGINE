...
{
    public const double MaxBloomRelativeEnergyDelta = 0.02;
    public const float MaxBloomCentroidDistance = 0.005f;
    ...
    public const float MinStaticEdgeSharpnessRatioToMono = 0.95f;
    public const float MinMovingEdgeSharpnessRatioToMono = 0.80f;
    public const double MaxTemporalConvergenceRmse = 0.01;
