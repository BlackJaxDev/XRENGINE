...
public partial class DefaultRenderPipeline
{
    ...
    private XRFrameBuffer CreateAtmosphereHalfScatterQuadFBO()
    {
        ...
        fbo.SettingUniforms += AtmosphereHalfScatterFBO_SettingUniforms;
        return fbo;
    }
    ...
    private XRFrameBuffer CreateAtmosphereReprojectQuadFBO()
    {
        ...
        fbo.SettingUniforms += AtmosphereReprojectFBO_SettingUniforms;
        return fbo;
    }
    ...
    private XRFrameBuffer CreateAtmosphereUpscaleQuadFBO()
    {
        ...
        fbo.SettingUniforms += AtmosphereUpscaleFBO_SettingUniforms;
        return fbo;
    }
    ...
    private IFrameBufferAttachement EnsureTextureAttachment(string textureName, Func<XRTexture> factory)
    {
        ...
        string actual = hasConcreteTexture && texture is not null
