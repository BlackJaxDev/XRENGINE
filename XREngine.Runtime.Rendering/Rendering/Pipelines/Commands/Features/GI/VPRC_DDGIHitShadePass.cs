...
namespace XREngine.Rendering.Pipelines.Commands
{
    ...
    public class VPRC_DDGIHitShadePass : VPRC_DDGIComputePass
    {
        ...
        internal override void DescribeRenderPass(RenderGraphDescribeContext context)
        {
            ...
            var builder = context.GetOrCreateSyntheticPass(nameof(VPRC_DDGIHitShadePass), ERenderGraphPassStage.Compute);
            builder.ReadBuffer(DDGILightResources.BufferName, ERenderPassResourceType.UniformBuffer);
            ...
            builder.ReadBuffer(ProbeBufferName);
            ...
            builder.WriteBuffer(RayRadianceBufferName);
