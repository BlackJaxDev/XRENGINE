...
namespace XREngine.Rendering
{
    ...
    public sealed class XRViewport : XRBase, IRuntimeViewportGrabSource, IRuntimeViewportHost, IRuntimeLocalPlayerViewport
    {
        ...
        /// </summary>
        public IRuntimeRenderWorld? WorldInstanceOverride { get; set; } = null;
        ...
        /// </summary>
        public IRuntimeRenderWorld? World => WorldInstanceOverride ?? CameraComponent?.SceneNode?.World as IRuntimeRenderWorld;
...
*/
            ...
            IRuntimeRenderWorld? world = worldOverride ?? World;
...
*/
        ...
        private void CollectVisible_ScreenSpaceUI()
        {
            ...
            IRuntimeScreenSpaceUserInterface? ui = ResolveScreenSpaceUICanvas();
            if (ui is null)
            {
                //if (s_vpScreenUIDiagCount < 5)
...
*/
        ...
        private IRuntimeScreenSpaceUserInterface? ResolveScreenSpaceUIForPipeline()
        {
            if (!AllowUIRender)
                return null;
        ...
        private IRuntimeScreenSpaceUserInterface? ResolveScreenSpaceUICanvas()
        {
            ...
            if (direct is not null && direct.IsActive && direct.IsScreenSpace)
                return direct;
            ...
            if (fallback is not null && !ReferenceEquals(camComp.UserInterface, fallback))
            {
                ...
                ResizeCameraComponentUI();
                Debug.Out($"[VP:ScreenUI] Rebound camera UI overlay for VP[{Index}].");
            }
