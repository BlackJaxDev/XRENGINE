...
{
    public partial class Lights3DCollection(IRuntimeRenderWorld world) : XRBase
    {
        #region Constants
        ...
        public IRuntimeRenderWorld World { get; } = world;
        ...
        public ShadowAtlasManager ShadowAtlas { get; } = new();
