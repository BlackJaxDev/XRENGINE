...
public sealed class GPUSoftbodyDispatcher
{
    ...
    public void Register(IGpuSoftbodyComputeSource component)
        => _registeredComponents.TryAdd(component.GetHashCode(), new GPUSoftbodyRequest(component));

    public void Unregister(IGpuSoftbodyComputeSource component)
        => _registeredComponents.TryRemove(component.GetHashCode(), out _);

    public bool IsRegistered(IGpuSoftbodyComputeSource component)
        => _registeredComponents.ContainsKey(component.GetHashCode());

    public bool TryGetClusterTransformOutput(IGpuSoftbodyComputeSource component, out XRDataBuffer? buffer, out int transformOffset, out int transformCount)
    {
        buffer = null;
        transformOffset = 0;
        transformCount = 0;
    ...
    public void SubmitData(
        IGpuSoftbodyComputeSource component,
...
public sealed class GPUSoftbodyRequest(IGpuSoftbodyComputeSource component)
{
    public object SyncRoot { get; } = new();
    public IGpuSoftbodyComputeSource Component { get; } = component;
