...
public static class EngineShaderBindingNames
{
    public static class Uniforms
    {
        ...
        public const string ShadowPackedI0 = "ShadowPackedI0";
        public const string ShadowPackedI1 = "ShadowPackedI1";
        public const string ShadowParams0 = "ShadowParams0";
        public const string ShadowParams1 = "ShadowParams1";
        public const string ShadowParams2 = "ShadowParams2";
        public const string ShadowParams3 = "ShadowParams3";
        public const string ShadowBiasParams = "ShadowBiasParams";
        public const string ShadowBiasProjectionParams = "ShadowBiasProjectionParams";
        public const string ShadowDepthMode = "ShadowDepthMode";
        public const string ShadowMapEncoding = "ShadowMapEncoding";
        public const string ShadowMomentParams0 = "ShadowMomentParams0";
        public const string ShadowMomentFilterParams = "ShadowMomentFilterParams";
        public const string DirectionalShadowMapEnabled = "DirectionalShadowMapEnabled";
        public const string DirectionalUseCascadedShadows = "DirectionalUseCascadedShadows";
        public const string DirectionalShadowBiasProjectionParams = "DirectionalShadowBiasProjectionParams";
        public const string DirectionalShadowAtlasEnabled = "DirectionalShadowAtlasEnabled";
        public const string DirectionalShadowMapEncoding = "DirectionalShadowMapEncoding";
        public const string DirectionalShadowMomentParams0 = "DirectionalShadowMomentParams0";
        public const string DirectionalShadowMomentFilterParams = "DirectionalShadowMomentFilterParams";
        public const string DirectionalShadowAtlasPacked0 = "DirectionalShadowAtlasPacked0";
        public const string DirectionalShadowAtlasParams0 = "DirectionalShadowAtlasParams0";
        public const string DirectionalShadowAtlasParams1 = "DirectionalShadowAtlasParams1";
        public const string DirectionalShadowAtlasMaxStaleFrames = "DirectionalShadowAtlasMaxStaleFrames";
