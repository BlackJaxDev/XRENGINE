    ...
    public static partial class RuntimeEngine
    {
        public static partial class Rendering
        {
            ...
            public static partial class Stats
            {
                ...
                {
                    bool gpuPipelineProfilingEnabled =
                        EnableTracking &&
                        RuntimeRenderingHostServices.FrameTiming.EnableGpuRenderPipelineProfiling;
...
#if !XRE_PUBLISHED
                    RuntimeRenderingHostServices.Statistics.PublishRenderStatsSnapshot();
#endif
                ...
                private static string CaptureActiveStereoMode()
                {
                    ...
                    if (RuntimeEngine.Rendering.Settings.VrViewRenderMode == EVrViewRenderMode.SinglePassStereo)
                    {
                        if (RuntimeEngine.VRState.IsOpenXRActive && RuntimeEngine.Rendering.State.IsVulkan)
                            return RuntimeEngine.VRState.OpenXRApi?.CanUseTrueSinglePassStereo == true
                ...
                {
                    EVrViewRenderMode requestedMode = RuntimeEngine.Rendering.Settings.VrViewRenderMode;
                    if (!RuntimeEngine.VRState.IsInVR && !RuntimeEngine.Rendering.State.IsStereoPass)
                    {
                        return new(
                            requestedMode,
