        ...
        public static partial class Rendering
        {
            public static partial class Stats
            {
                public static class FrameOutputs
                {
                    ...
                    internal static void SnapshotAndReset()
                    {
                        lock (Sync)
                        {
                            ...
                            _lastManifest = new FrameOutputManifestSnapshot(
                                ...
                                RuntimeEngine.Rendering.Settings.VrMirrorMode,
                    ...
                    {
                        double vrHz = RuntimeEngine.Rendering.Stats.Vr.VrRenderFrameRateHz;
                        if (RuntimeEngine.VRState.IsInVR && vrHz > 1.0 && double.IsFinite(vrHz))
                            return (float)Math.Clamp(vrHz, 1.0, 1000.0);

                        float target = RuntimeRenderingHostServices.FrameTiming.TargetRenderFrequency;
                    ...
                    {
                        EVrMirrorMode mirrorMode = RuntimeEngine.Rendering.Settings.VrMirrorMode;
