    ...
    public static class UniformRequirementsDetection
    {
        ...
        public static readonly FrozenDictionary<string, EUniformRequirements> UniformToRequirement =
            new Dictionary<string, EUniformRequirements>(StringComparer.Ordinal)
            {
                ...
                // Packed and array shadow state is published by the same immutable
                // forward-lighting snapshot as the legacy scalar names below. Keep
                // every numeric member classified so persistent Vulkan artifacts
                // retain it and include it in their lighting-content signature.
                [EngineShaderBindingNames.Uniforms.ShadowPackedI0] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowPackedI1] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowParams0] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowParams1] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowParams2] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowParams3] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowBiasParams] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowBiasProjectionParams] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowDepthMode] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowMapEncoding] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowMomentParams0] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.ShadowMomentFilterParams] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowMapEnabled] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalUseCascadedShadows] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowBiasProjectionParams] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowAtlasEnabled] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowMapEncoding] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowMomentParams0] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowMomentFilterParams] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowAtlasPacked0] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowAtlasParams0] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowAtlasParams1] = EUniformRequirements.Lights,
                [EngineShaderBindingNames.Uniforms.DirectionalShadowAtlasMaxStaleFrames] = EUniformRequirements.Lights,
                ...
                [EngineShaderBindingNames.Uniforms.ShadowVogelTapCount] = EUniformRequirements.Lights,
                ...
                [EngineShaderBindingNames.Uniforms.PointLightShadowVogelTapCount] = EUniformRequirements.Lights,
                ...
                [EngineShaderBindingNames.Uniforms.SpotLightShadowVogelTapCount] = EUniformRequirements.Lights,
