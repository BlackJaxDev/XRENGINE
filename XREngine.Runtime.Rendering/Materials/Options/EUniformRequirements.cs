    ...
    public static class UniformRequirementsDetection
    {
        ...
        public static readonly FrozenDictionary<string, EUniformRequirements> UniformToRequirement =
            new Dictionary<string, EUniformRequirements>(StringComparer.Ordinal)
            {
                ...
                [EngineShaderBindingNames.Uniforms.EnablePCSS] = EUniformRequirements.Lights,
                ...
                [EngineShaderBindingNames.Uniforms.PointLightShadowEnablePCSS] = EUniformRequirements.Lights,
                ...
                [EngineShaderBindingNames.Uniforms.SpotLightShadowEnablePCSS] = EUniformRequirements.Lights,
