...
{
    internal void CollectUnityHumanoidContributions(
        ...
        bool mirror)
    {
        switch (this)
        {
            case AnimationClip clip:
                if (clip.TryCreateUnityHumanoidMotionContribution(
                    normalizedTime,
                    weight,
            ...
            case BlendTree1D tree1D:
                tree1D.CollectUnityHumanoidChildContributions(
                    destination,
                    variables,
                    normalizedTime,
                    weight,
            ...
            case BlendTree2D tree2D:
                tree2D.CollectUnityHumanoidChildContributions(
                    destination,
                    variables,
                    normalizedTime,
                    weight,
            ...
            case BlendTreeDirect directTree:
                directTree.CollectUnityHumanoidChildContributions(
                    destination,
                    variables,
                    normalizedTime,
                    weight,
