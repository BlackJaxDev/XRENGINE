...
/// </summary>
[MemoryPackable]
public sealed partial record UnityAnimationBindingDescriptor
{
    ...
    public UnityAssetReference Script { get; init; }
    public EUnityAnimationBindingValueKind ValueKind { get; init; }
