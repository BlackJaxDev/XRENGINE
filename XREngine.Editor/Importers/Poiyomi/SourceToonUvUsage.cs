...
/// </summary>
internal static class SourceToonUvUsage
{
    public static int[] GetRequestedChannels(SerializedMaterialDocument document)
    {
    ...
    public static MaterialConversionDiagnostic[] Validate(SerializedMaterialDocument document, uint availableChannelCount)
    {
