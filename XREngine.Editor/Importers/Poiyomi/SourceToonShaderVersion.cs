...
/// </summary>
public readonly record struct SourceToonShaderVersion(int Major, int Minor, int Patch)
{
    public static bool TryParse(string? value, out SourceToonShaderVersion version)
    {
        version = default;
        ...
        version = new SourceToonShaderVersion(major, minor, patch);
        return true;
    }
