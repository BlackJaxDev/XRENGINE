...
/// </summary>
public sealed class SerializedModelImporterDocument
{
    ...
    public IReadOnlyList<SerializedModelSkeletonTransform> SkeletonTransforms { get; init; } = [];
    public IReadOnlyList<SourceExternalMaterialRemap> ExternalMaterialRemaps { get; init; } = [];
}
