...
{
    private static void ApplySourceToonEffectsAndIntegrations(
        XRMaterial material,
    ...
    {
        bool outlines = SourceToonFeatureStateResolver.IsEnabled(
            document,
        ...
        if (vertexEffects)
        {
            AttachSourceToonVertexShaders(material);
    ...
    private static bool HasSpecialEffects(SerializedMaterialDocument document)
        => HasAnyPositive(
            document,
    ...
    private static bool HasVertexEffects(SerializedMaterialDocument document)
    ...
    private static void MapOutlineAndDissolve(XRMaterial material, SerializedMaterialDocument document)
    {
    ...
    private static void MapSpecialEffects(XRMaterial material, SerializedMaterialDocument document)
    {
    ...
    private static void MapVertexEffects(XRMaterial material, SerializedMaterialDocument document)
    {
    ...
    private static void AttachSourceToonVertexShaders(XRMaterial material)
    {
        material.SetShader(
            EShaderType.Vertex,
