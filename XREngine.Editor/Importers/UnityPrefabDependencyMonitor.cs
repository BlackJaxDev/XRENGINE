...
/// </summary>
public static class UnityPrefabDependencyMonitor
{
    private static readonly object Sync = new();
    private static readonly Dictionary<string, Registration> Registrations =
        new(StringComparer.OrdinalIgnoreCase);

    public static void Register(UnityPrefabImportManifest manifest)
    {
    ...
    {
        private readonly UnityPrefabImportManifest _manifest;
        ...
        public Registration(UnityPrefabImportManifest manifest)
        {
            _manifest = manifest;
        ...
        private async Task ReimportAsync()
        {
            try
            {
                ...
                {
                    UnityProjectRootOverride = _manifest.UnityProjectRoot,
        ...
        {
            string projectRoot = Path.GetFullPath(manifest.UnityProjectRoot);
