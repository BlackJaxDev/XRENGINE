...
{
    public static class SerializedAssetConverter
    {
        ...
        public static AnimationClip ConvertFloatAnimation(SerializedAnimationClip animClip)
        {
            ...
            animClip.FloatCurves?.ForEach(curve =>
            {
                ...
                {
                    var leftTangentMode = SerializedAnimationClip.TangentModeHelper.GetLeftTangentMode(kf.CombinedTangentMode);
                    var rightTangentMode = SerializedAnimationClip.TangentModeHelper.GetRightTangentMode(kf.CombinedTangentMode);
                    ...
                    if (!SerializedAnimationClip.TangentModeHelper.IsBroken(kf.CombinedTangentMode) &&
