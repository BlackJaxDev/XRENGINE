...
/// </summary>
public sealed class SerializedMaterialDocument
{
    ...
    public SourceAssetReference Shader { get; init; }
    ...
    public Dictionary<string, SerializedTexturePropertyDocument> Textures { get; } = new(StringComparer.Ordinal);
