...
/// </summary>
[Serializable]
public sealed class SourceImportDependencyManifestEntry
{
    public string? SourceGuid { get; set; }
    public long? LocalFileId { get; set; }
    public string NormalizedPath { get; set; } = string.Empty;
    public SourceImportDependencyKind Kind { get; set; }
    public string? ReferringProperty { get; set; }
    public long LastWriteTimeUtcTicks { get; set; }
    public long Length { get; set; }
    public string Sha256 { get; set; } = string.Empty;
    public string? OutputAssetPath { get; set; }
    public SourceImportConversionOutcome Outcome { get; set; }
}
