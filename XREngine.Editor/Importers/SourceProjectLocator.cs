...
/// </summary>
public static class SourceProjectLocator
{
    public static SourceProjectLocation Locate(string sourcePath, string? explicitProjectOrAssetsRoot = null)
    {
        ...
        return new SourceProjectLocation
        {
            ProjectRoot = projectRoot,
            AssetsRoot = assetsRoot,
            SourceEditorVersion = TryReadEditorVersion(versionPath),
    ...
    public static bool TryLocate(
        string sourcePath,
        out SourceProjectLocation? location,
        out string? error,
