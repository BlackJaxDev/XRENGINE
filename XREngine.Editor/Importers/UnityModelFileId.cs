...
/// </summary>
public static class UnityModelFileId
{
    ...
    public static long Compute(string unityTypeName, string identifier)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(unityTypeName);
        ArgumentException.ThrowIfNullOrWhiteSpace(identifier);
        byte[] bytes = Encoding.UTF8.GetBytes($"Type:{unityTypeName}->{identifier}0");
