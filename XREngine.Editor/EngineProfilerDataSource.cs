...
internal sealed class EngineProfilerDataSource : IProfilerDataSource
{
    ...
    private static RenderStatsPacket? CollectRenderStats()
    {
        ...
        return new RenderStatsPacket
        {
            ...
            VulkanLifetimeLiveResourceCount = Engine.Rendering.Stats.Vulkan.VulkanLifetimeLiveResourceCount,
            VulkanTrackedDescriptorSetCount = Engine.Rendering.Stats.Vulkan.VulkanTrackedDescriptorSetCount,
            VulkanLifetimePendingRetirementCount = Engine.Rendering.Stats.Vulkan.VulkanLifetimePendingRetirementCount,
            VulkanLifetimeOldestPendingRetirementAgeMilliseconds = Engine.Rendering.Stats.Vulkan.VulkanLifetimeOldestPendingRetirementAgeMilliseconds,
            ...
            VulkanMeshFrameDataArenaChunkCount = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataArenaChunkCount,
            VulkanMeshFrameDataMappedBytes = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataMappedBytes,
            VulkanMeshFrameDataReservedBytes = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataReservedBytes,
            VulkanMeshFrameDataReservationCount = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataReservationCount,
            VulkanMeshFrameDataGeneration = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataGeneration,
            VulkanMeshFrameDataRecordingLeases = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataRecordingLeases,
            VulkanMeshFrameDataCachedLeases = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataCachedLeases,
            VulkanMeshFrameDataSubmittedLeases = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataSubmittedLeases,
            VulkanMeshFrameDataActiveGenerationCount = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataActiveGenerationCount,
            VulkanMeshFrameDataLeaseRetainedGenerationCount = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataLeaseRetainedGenerationCount,
            VulkanMeshDescriptorAllocationVariants = Engine.Rendering.Stats.Vulkan.VulkanMeshDescriptorAllocationVariants,
            VulkanMeshDescriptorPools = Engine.Rendering.Stats.Vulkan.VulkanMeshDescriptorPools,
            VulkanMeshDescriptorAllocatedSets = Engine.Rendering.Stats.Vulkan.VulkanMeshDescriptorAllocatedSets,
            VulkanMeshDescriptorReservedSets = Engine.Rendering.Stats.Vulkan.VulkanMeshDescriptorReservedSets,
            VulkanMeshFrameDataArenaChunkHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataArenaChunkHighWater,
            VulkanMeshFrameDataMappedBytesHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataMappedBytesHighWater,
            VulkanMeshFrameDataReservedBytesHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataReservedBytesHighWater,
            VulkanMeshFrameDataReservationHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataReservationHighWater,
            VulkanMeshFrameDataLeaseHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshFrameDataLeaseHighWater,
            VulkanMeshDescriptorAllocationVariantHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshDescriptorAllocationVariantHighWater,
            VulkanMeshDescriptorPoolHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshDescriptorPoolHighWater,
            VulkanMeshDescriptorSetHighWater = Engine.Rendering.Stats.Vulkan.VulkanMeshDescriptorSetHighWater,
            ...
            {
                FrameSampleTimingQueriesMs = Engine.Rendering.Stats.Vulkan.VulkanFrameSampleTimingQueriesMs,
                FrameDrainRetiredResourcesMs = Engine.Rendering.Stats.Vulkan.VulkanFrameDrainRetiredResourcesMs,
                ...
                FrameOpIndirectDrawCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpIndirectDrawCount,
                FrameOpMeshTaskDispatchCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpMeshTaskDispatchCount,
                FrameOpBlitCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpBlitCount,
                FrameOpComputeCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpComputeCount,
                FrameOpSwapchainWriteCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpSwapchainWriteCount,
                FrameOpFboWriteCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpFboWriteCount,
                FrameOpUniquePassCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpUniquePassCount,
                FrameOpUniqueContextCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpUniqueContextCount,
                FrameOpUniqueTargetCount = Engine.Rendering.Stats.Vulkan.VulkanFrameOpUniqueTargetCount,
                ...
                CommandBufferForcedDirtyCount = Engine.Rendering.Stats.Vulkan.VulkanCommandBufferForcedDirtyCount,
                CommandBufferFrameOpSignatureDirtyCount = Engine.Rendering.Stats.Vulkan.VulkanCommandBufferFrameOpSignatureDirtyCount,
                CommandBufferPlannerDirtyCount = Engine.Rendering.Stats.Vulkan.VulkanCommandBufferPlannerDirtyCount,
                CommandBufferProfilerDirtyCount = Engine.Rendering.Stats.Vulkan.VulkanCommandBufferProfilerDirtyCount,
                CommandBufferDirtySummary = Engine.Rendering.Stats.Vulkan.VulkanCommandBufferDirtySummary,
                CommandChainsScheduled = Engine.Rendering.Stats.Vulkan.VulkanCommandChainsScheduled,
                CommandChainsRecorded = Engine.Rendering.Stats.Vulkan.VulkanCommandChainsRecorded,
                CommandChainsReused = Engine.Rendering.Stats.Vulkan.VulkanCommandChainsReused,
                CommandChainsFrameDataRefreshed = Engine.Rendering.Stats.Vulkan.VulkanCommandChainsFrameDataRefreshed,
                VolatileCommandChainsRecorded = Engine.Rendering.Stats.Vulkan.VulkanVolatileCommandChainsRecorded,
                PrimaryCommandBuffersReused = Engine.Rendering.Stats.Vulkan.VulkanPrimaryCommandBuffersReused,
                PrimaryCommandBuffersRecorded = Engine.Rendering.Stats.Vulkan.VulkanPrimaryCommandBuffersRecorded,
                VisibilityPacketCount = Engine.Rendering.Stats.Vulkan.VulkanVisibilityPacketCount,
                RenderPacketCount = Engine.Rendering.Stats.Vulkan.VulkanRenderPacketCount,
                SecondaryCommandBufferCount = Engine.Rendering.Stats.Vulkan.VulkanSecondaryCommandBufferCount,
                CommandChainWorkerRecordMs = Engine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerRecordMs,
                RenderThreadWaitForChainWorkersMs = Engine.Rendering.Stats.Vulkan.VulkanRenderThreadWaitForChainWorkersMs,
                FirstCommandChainStructuralDirtyReason = Engine.Rendering.Stats.Vulkan.VulkanFirstCommandChainStructuralDirtyReason,
                FirstCommandChainDescriptorGenerationMismatch = Engine.Rendering.Stats.Vulkan.VulkanFirstCommandChainDescriptorGenerationMismatch,
                FirstCommandChainResourcePlanRevisionMismatch = Engine.Rendering.Stats.Vulkan.VulkanFirstCommandChainResourcePlanRevisionMismatch,
                RetiredDescriptorPoolCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredDescriptorPoolCount,
                RetiredPipelineCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredPipelineCount,
                RetiredFramebufferCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredFramebufferCount,
                RetiredBufferCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredBufferCount,
                RetiredBufferMemoryCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredBufferMemoryCount,
                RetiredImageCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredImageCount,
                RetiredImageViewCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredImageViewCount,
                RetiredSamplerCount = Engine.Rendering.Stats.Vulkan.VulkanRetiredSamplerCount,
