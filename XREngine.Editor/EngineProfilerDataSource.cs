...
internal sealed class EngineProfilerDataSource : IProfilerDataSource
{
    ...
    private static RenderStatsPacket? CollectRenderStats()
    {
        ...
        return new RenderStatsPacket
        {
            ...
            GpuMeshletRequestedFrames = Engine.Rendering.Stats.GpuMeshletRequestedFrames,
            GpuMeshletProductionFrames = Engine.Rendering.Stats.GpuMeshletProductionFrames,
            GpuMeshletFallbackFrames = Engine.Rendering.Stats.GpuMeshletFallbackFrames,
            GpuMeshletDispatchSkipped = Engine.Rendering.Stats.GpuMeshletDispatchSkipped,
            GpuMeshletTaskRecordsEmitted = Engine.Rendering.Stats.GpuMeshletTaskRecordsEmitted,
            GpuMeshletTaskRecordsFrustumCulled = Engine.Rendering.Stats.GpuMeshletTaskRecordsFrustumCulled,
            GpuMeshletTaskRecordsConeCulled = Engine.Rendering.Stats.GpuMeshletTaskRecordsConeCulled,
            GpuMeshletTaskRecordsHiZCulled = Engine.Rendering.Stats.GpuMeshletTaskRecordsHiZCulled,
            GpuMeshletExpansionOverflowCount = Engine.Rendering.Stats.GpuMeshletExpansionOverflowCount,
            GpuMeshletBufferBytesResident = Engine.Rendering.Stats.GpuMeshletBufferBytesResident,
            GpuMeshletCacheHits = Engine.Rendering.Stats.GpuMeshletCacheHits,
            GpuMeshletCacheMisses = Engine.Rendering.Stats.GpuMeshletCacheMisses,
            GpuMeshletCacheStale = Engine.Rendering.Stats.GpuMeshletCacheStale,
            ...
            VrLeftEyeDraws = Engine.Rendering.Stats.VrLeftEyeDraws,
            VrRightEyeDraws = Engine.Rendering.Stats.VrRightEyeDraws,
            VrLeftEyeVisible = Engine.Rendering.Stats.VrLeftEyeVisible,
            VrRightEyeVisible = Engine.Rendering.Stats.VrRightEyeVisible,
            VrLeftWorkerBuildTimeMs = Engine.Rendering.Stats.VrLeftWorkerBuildTimeMs,
            VrRightWorkerBuildTimeMs = Engine.Rendering.Stats.VrRightWorkerBuildTimeMs,
            VrRenderSubmitTimeMs = Engine.Rendering.Stats.VrRenderSubmitTimeMs,
            VrXrWaitFrameBlockTimeMs = Engine.Rendering.Stats.VrXrWaitFrameBlockTimeMs,
            VrXrEndFrameSubmitTimeMs = Engine.Rendering.Stats.VrXrEndFrameSubmitTimeMs,
            VrXrPredictedToLatePoseDeltaMillimeters = Engine.Rendering.Stats.VrXrPredictedToLatePoseDeltaMillimeters,
            VrXrPredictedToLatePoseDeltaDegrees = Engine.Rendering.Stats.VrXrPredictedToLatePoseDeltaDegrees,
            VrXrPredictedDisplayLeadTimeMs = Engine.Rendering.Stats.VrXrPredictedDisplayLeadTimeMs,
            VrXrMissedDeadlineFrames = Engine.Rendering.Stats.VrXrMissedDeadlineFrames,
            VrXrTrackingLossFrames = Engine.Rendering.Stats.VrXrTrackingLossFrames,
            VrXrRelocatePredictedTimeMs = Engine.Rendering.Stats.VrXrRelocatePredictedTimeMs,
            VrXrCollectFrustumExpansionDegrees = Engine.Rendering.Stats.VrXrCollectFrustumExpansionDegrees,
            VrXrPacingThreadIdleTimeMs = Engine.Rendering.Stats.VrXrPacingThreadIdleTimeMs,
            VrXrPacingHandoffStalls = Engine.Rendering.Stats.VrXrPacingHandoffStalls,
