...
public static partial class EditorUnitTests
{
    ...
    public class Settings
    {
        ...
        public int OpenGLProgramCompileLinkWorkerCount { get; set; } = 1; //Number of shared-context workers used for uncached OpenGL shader programs. XRE_DISABLE_OPENGL_COMPILE_LINK_WORKER_POOL=1 forces the single-worker compatibility path.
