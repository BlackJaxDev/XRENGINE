...
public partial class PhysicsChainComponent : XRComponent
{
    ...
    private PhysicsChainCoefficientCurve? _dampingDistrib = null;

    private float _elasticity = 0.1f;
    private PhysicsChainCoefficientCurve? _elasticityDistrib = null;

    private float _stiffness = 0.1f;
    private PhysicsChainCoefficientCurve? _stiffnessDistrib = null;

    private float _inert = 0.0f;
    private PhysicsChainCoefficientCurve? _inertDistrib = null;

    private float _friction = 0.0f;
    private PhysicsChainCoefficientCurve? _frictionDistrib = null;

    private float _radius = 0.01f;
    private PhysicsChainCoefficientCurve? _radiusDistrib = null;
    ...
    public PhysicsChainCoefficientCurve? DampingDistrib
    {
        get => _dampingDistrib;
    ...
    public PhysicsChainCoefficientCurve? ElasticityDistrib
    {
    ...
    public PhysicsChainCoefficientCurve? StiffnessDistrib
    {
    ...
    public PhysicsChainCoefficientCurve? InertDistrib
    {
        get => _inertDistrib;
    ...
    public PhysicsChainCoefficientCurve? FrictionDistrib
    {
    ...
    public PhysicsChainCoefficientCurve? RadiusDistrib
    {
        get => _radiusDistrib;
