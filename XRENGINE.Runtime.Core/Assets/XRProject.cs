...
namespace XREngine
{
    ...
    public partial class XRProject : XRAsset
    {
        ...
        public static XRProject CreateNew(
            string projectDirectoryPath,
            string projectName,
            AssetManager assets)
        {
            ArgumentNullException.ThrowIfNull(assets);
            XRProject project = CreateNew(projectDirectoryPath, projectName);
            assets.EnsureTracked(project);
            return project;
        }
        ...
        public static XRProject? Load(string projectFilePath, AssetManager assets)
        {
            ArgumentNullException.ThrowIfNull(assets);
