...
namespace XREngine
{
    public partial class AssetManager
    {
        ...
        private static IReadOnlyList<IYamlTypeConverter> CreateYamlTypeConverters()
        {
            ...
            foreach (IYamlSerializationContribution contribution in YamlSerializationContributions.Snapshot())
                converters.AddRange(contribution.CreateTypeConverters());
        ...
        private static ISerializer CreateSerializer()
        {
            ...
            foreach (IYamlSerializationContribution contribution in YamlSerializationContributions.Snapshot())
                contribution.ConfigureSerializer(builder);
        ...
        private static IDeserializer CreateDeserializer()
        {
            ...
            foreach (IYamlSerializationContribution contribution in YamlSerializationContributions.Snapshot())
                contribution.ConfigureDeserializer(builder);
