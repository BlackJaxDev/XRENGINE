...
public static class ModelImportCanonicalSettings
{
    public static byte[] Serialize(ModelImportOptions options, string sourceFilePath)
    {
        ...
        writer.WriteUInt64(10, Convert.ToUInt64(options.PostProcessSteps));
        ...
        writer.WriteString(23, NormalizeResolutionPath(options.UnityProjectRootOverride, sourceFilePath));
