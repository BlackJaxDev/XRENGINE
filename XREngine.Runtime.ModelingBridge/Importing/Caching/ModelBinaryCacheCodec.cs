...
namespace XREngine.Rendering.Models.Caching
{
    ...
    /// </summary>
    internal sealed class ModelBinaryCacheCodec(Type modelAssetType) : IThirdPartyCacheCodec
    {
        private readonly Type _modelAssetType = modelAssetType ?? throw new ArgumentNullException(nameof(modelAssetType));

        /// <summary>
        /// Creates a codec that recognizes assets through the modeling-owned marker contract.
        /// Production composition may use the type-specific constructor to narrow ownership.
        /// </summary>
        public ModelBinaryCacheCodec()
            : this(typeof(IModelCacheAsset))
        {
        }
