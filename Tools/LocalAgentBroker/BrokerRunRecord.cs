    ...
    public AgentRunSnapshot Snapshot()
    {
        lock (_sync)
        {
            ...
            return new AgentRunSnapshot
            {
                ...
                ContextFileCount = Request.ContextFileSnapshots.Count,
                ContextRawBytes = Request.ContextFileSnapshots.Sum(static snapshot => snapshot.RawByteLength),
                RepositoryAccessEnabled = Request.RepositoryAccess.Enabled,
