# Poiyomi Phase 11 Material Authoring

Phase 11 replaces the flat Poiyomi material view with an engine-native,
...
The focused Phase 11 fixtures validate the real embedded 3,000+ node catalog,
...
The focused editor build and Phase 11 test fixture are the minimum regression
