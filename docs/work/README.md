...
| Vulkan frame-wide render loop | Proposed | [design/rendering/vulkan-render-loop-design.md](design/rendering/vulkan-render-loop-design.md), [todo/rendering/vulkan-frame-wide-render-loop-todo.md](todo/rendering/vulkan-frame-wide-render-loop-todo.md) | Execution plan for canonical logical views, exact masked CPU/GPU BVH visibility, planned XR multiview batches, physical-eye Hi-Z reuse, resource-versioned graph compilation, and XR-deadline-aware output scheduling. |
...
- [todo/rendering/vulkan-frame-wide-render-loop-todo.md](todo/rendering/vulkan-frame-wide-render-loop-todo.md)
