...
| Vulkan core hardening and frame-wide render loop | Active | [todo/rendering/vulkan-core-hardening-and-device-loss-todo.md](todo/rendering/vulkan-core-hardening-and-device-loss-todo.md), [design/rendering/vulkan-render-loop-design.md](design/rendering/vulkan-render-loop-design.md) | Canonical execution plan for Vulkan robustness and Phase 5.2A CPU-direct, 5.2B GPU-indirect, and 5.2C meshlet promotion: generation-safe command reuse, capacity-backed dynamic data, stable GPU-driven topology, canonical logical views, exact masked CPU/GPU BVH visibility, planned XR multiview batches, resource-versioned graph compilation, and XR-deadline-aware scheduling. |
