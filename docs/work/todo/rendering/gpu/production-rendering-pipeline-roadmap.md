...
| W5 | Bindless / descriptor-indexing material table is not actually functional. `BindlessMaterialTable` exists but is texture-incorrect (no real GL handle population). | [gpu-rendering.md](gpu-rendering.md) 2026-05-08 update | High |
