...
Owner: Rendering
Status: Historical completion and evidence record through the 2026-08-10 Phase 4 implementation closeout
Open Work: [Vulkan core hardening and device-loss TODO](../rendering/vulkan-core-hardening-and-device-loss-todo.md)
...
[current todo](../rendering/vulkan-core-hardening-and-device-loss-todo.md).
...
criteria in the [current TODO](../rendering/vulkan-core-hardening-and-device-loss-todo.md);
...
in the [current todo](../rendering/vulkan-core-hardening-and-device-loss-todo.md).
...
## Core Hardening Phases 1 Through 4 Completed Implementation - 2026-08-10

The checked cross-cutting invariant and Phase 1 through Phase 4 implementation
criteria moved from the active tracker on 2026-08-12.
...
The checklist was restored in the [current todo](../rendering/vulkan-core-hardening-and-device-loss-todo.md)
