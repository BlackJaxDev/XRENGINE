# Poiyomi Toon 9.3 Conversion Baseline Complete
...
conversion baseline replaces the converter's ambiguous texture aliases with independent
runtime contracts:
...
use the catalog inventory pinned GUID/version/signature matcher rather than shader paths.
...
- Focused catalog inventory-2 and legacy importer suite
  - Passed: 21/21.
- Enabled conversion baseline uber feature combination
