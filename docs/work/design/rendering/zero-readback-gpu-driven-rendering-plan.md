...
This plan supersedes the earlier hybrid assumptions where CPU batch iteration remained part of the render loop. The indirect GPU rendering architecture reference is now consolidated into `docs/work/todo/rendering/gpu/production-rendering-pipeline-roadmap.md`.
