...
namespace SerializedAssets
{
    ...
    public partial class SerializedAnimationClip : XRAsset
    {
        public class Wrapper
        {
            [YamlMember(Alias = "AnimationClip")]
            public SerializedAnimationClip? Clip { get; set; }
        }
        public static SerializedAnimationClip? Load3rdPartyStatic(string filePath)
        {
            // Load the Unity animation clip from the specified file path
            IDeserializer deserializer = new StaticDeserializerBuilder(new SourceStaticContext())
        ...
        public SourceBounds? Bounds { get; set; }
    ...
    public class SourceBounds
    {
        [YamlMember(Alias = "m_Center")]
        public SourceVector3? Center { get; set; }

        [YamlMember(Alias = "m_Extent")]
        public SourceVector3? Extent { get; set; }
    }

    public class SourceVector3
    {
        [YamlMember(Alias = "x")]
