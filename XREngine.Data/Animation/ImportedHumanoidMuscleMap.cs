...
{
    public static class ImportedHumanoidMuscleMap
    {
        ...
        public static bool TryGetValue(string sourceName, out EHumanoidValue value)
            => NameToValue.TryGetValue(sourceName, out value);

        public static bool TryGetSourceName(EHumanoidValue value, out string sourceName)
            => ValueToHumanTraitName.TryGetValue(value, out sourceName!);
