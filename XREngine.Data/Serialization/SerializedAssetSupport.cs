...
public static class SerializedAssetSupport
{
    ...
    public sealed class CookedBinaryMemoryPackFormatter<TAsset>(Func<byte[]?, TAsset?> deserializePayload) : MemoryPackFormatter<TAsset>
        where TAsset : class
    {
