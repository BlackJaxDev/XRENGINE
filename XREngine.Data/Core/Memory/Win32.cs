...
namespace XREngine.Data
{
    public static class Win32
    {
        ...
        [DllImport("Kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern VoidPtr MapViewOfFile(VoidPtr hFileMappingObject, FileMapAccess dwDesiredAccess, uint dwFileOffsetHigh, uint dwFileOffsetLow, nuint dwNumberOfBytesToMap);
        [DllImport("Kernel32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern VoidPtr MapViewOfFileEx(VoidPtr hFileMappingObject, FileMapAccess dwDesiredAccess, uint dwFileOffsetHigh, uint dwFileOffsetLow, nuint dwNumberOfBytesToMap, VoidPtr lpBaseAddress);
        [DllImport("Kernel32.dll", CharSet = CharSet.Unicode)]
