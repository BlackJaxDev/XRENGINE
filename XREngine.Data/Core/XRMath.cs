...
namespace XREngine.Data.Core
{
    public unsafe static class XRMath
    {
        ...
        /// 
        /// The reflection formula is: R = V - 2(V意)N
        /// Where:
        ...
        /// - V意 is the dot product representing how much V points in the same direction as N
        /// 
        /// The formula works by:
        /// 1. Computing how much the vector points in the normal direction (V意)
        /// 2. Scaling the normal by this amount and doubling it (2(V意)N)
