...
public static class XREngineEnvironmentVariables
{
    ...
    public const string UnitTestRenderPipeline = "XRE_UNIT_TEST_RENDER_PIPELINE";
    ...
    public const string OpenXrSubmissionValidation = "XRE_OPENXR_SUBMISSION_VALIDATION";
