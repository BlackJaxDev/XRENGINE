...
public enum EVulkanCpuStage
{
    ...
    FrameOpSort,
    FrameOpCohort,
    PreparedMeshBindingValidation,
    PreparedMeshHoleMaterialization,
    FrameOpResourceUseLowering,
    FrameOpSplit,
    FrameOpSignature,
    FrameOpPlan,
    ...
    PrimaryAdvancedVisibilityOperation,
    PrimaryComputeOperation,
    PrimaryBlitOperation,
    PrimaryClearOperation,
    PrimaryOtherOperation,
    PrimaryAdvancedPreparationOperation,
    PrimaryAdvancedRasterOperation,
    PrimaryAdvancedLateComputeOperation,
    PrimaryAdvancedLateRasterOperation,
