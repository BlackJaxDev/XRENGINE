...
namespace XREngine
{
    public static class AssetManagerPrefabExtensions
    {
                                             ...
                                             bool maintainWorldTransform = false)
        {
            ...
            return SceneNodePrefabUtility.InstantiateVariant(
                variant,
                world,
                parent,
                maintainWorldTransform,
                new AssetManagerPrefabSourceResolver(assets));
        }
        ...
        private sealed class AssetManagerPrefabSourceResolver(AssetManager assets) : IRuntimePrefabSourceResolver
        {
            public XRPrefabSource? Resolve(Guid prefabAssetId)
                => assets.GetAssetByID(prefabAssetId) as XRPrefabSource;
        }
    }
}
