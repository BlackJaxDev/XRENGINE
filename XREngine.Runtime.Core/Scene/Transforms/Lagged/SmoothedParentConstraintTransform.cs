    ...
    public class SmoothedParentConstraintTransform : TransformBase
    {
        ...
        private void CalcCurrentMatrix()
        {
            ...
            if (TranslationInterpolationSpeed.HasValue)
                currTrans = Vector3.Lerp(currTrans, destTrans, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * TranslationInterpolationSpeed.Value);
            else
                currTrans = destTrans;
            ...
            if (UseLookAtYawPitch)
            {
                ...
                if (IgnorePitch)
                    ...
                    InterpAndWrap(ref currPitch, destPitch, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * PitchInterpolationSpeed.Value);
                else
                    currPitch = destPitch;
                ...
                if (IgnoreYaw)
                    ...
                    InterpAndWrap(ref currYaw, destYaw, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * YawInterpolationSpeed.Value);
                else
                    currYaw = destYaw;
            ...
            else if (SplitYPR)
            {
                ...
                if (IgnorePitch)
                    ...
                    InterpAndWrap(ref v.X, v2.X, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * PitchInterpolationSpeed.Value);
                else
                    v.X = v2.X;
                ...
                if (IgnoreYaw)
                    ...
                    InterpAndWrap(ref v.Y, v2.Y, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * YawInterpolationSpeed.Value);
                else
                    v.Y = v2.Y;
                ...
                if (IgnoreRoll)
                    ...
                    InterpAndWrap(ref v.Z, v2.Z, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * RollInterpolationSpeed.Value);
                else
                    v.Z = v2.Z;
                ...
                currRot = Quaternion.Lerp(currRot, destRot, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * QuaternionInterpolationSpeed.Value);
            else
                currRot = destRot;

            if (ScaleInterpolationSpeed.HasValue)
                currScale = Vector3.Lerp(currScale, destScale, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * ScaleInterpolationSpeed.Value);
            else
                currScale = destScale;
            ...
            //_currentMatrix = Matrix4x4.Lerp(_currentMatrix, ParentWorldMatrix, (RuntimeTransformServices.Current?.DilatedUpdateDeltaSeconds ?? 0.0f) * TranslationInterpolationSpeed);
        }
