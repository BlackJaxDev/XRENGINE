...
{
    public unsafe class PhysxTriangleMesh(PxTriangleMesh* triangleMesh) : PhysxRefCounted
    {
        [RuntimeOnly]
        public PxTriangleMesh* TriangleMeshPtr { get; private set; } = triangleMesh;

        public override PxRefCounted* RefCountedPtr => (PxRefCounted*)TriangleMeshPtr;
