...
namespace XREngine.Scene.Physics.Physx
{
    public unsafe abstract class PhysxActor : PhysxBase, IAbstractPhysicsActor
    {
        ...
        public virtual void Release()
        {
            ...
            if (!RuntimePhysicsServices.Current.IsPhysicsThread && !RuntimePhysicsServices.Current.IsShuttingDown)
            {
                RuntimeThreadServices.Current.EnqueuePhysicsThread(ReleaseNativeNow);
                return;
            }
