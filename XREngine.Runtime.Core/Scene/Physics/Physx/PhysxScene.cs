    ...
    public unsafe partial class PhysxScene : AbstractPhysicsScene
    {
        ...
        public override void OnEnterPlayMode()
        {
            ...
            foreach (var dyn in PhysxDynamicRigidBody.AllDynamic.Values)
            {
                if (dyn.IsReleased)
                    continue;
                if (dyn.OwningComponent?.WorldAs<IRuntimePhysicsWorldContext>()?.PhysicsScene != this)
                    continue;
                owned.Add(dyn);
            }
            foreach (var stat in PhysxStaticRigidBody.AllStaticRigidBodies.Values)
            {
                if (stat.IsReleased)
                    continue;
                if (stat.OwningComponent?.WorldAs<IRuntimePhysicsWorldContext>()?.PhysicsScene != this)
                    continue;
                owned.Add(stat);
            }
        ...
        private static void UpdatePhysicsActor(PxActor** ptr, int i)
        {
            ...
            switch (actor)
            {
                case PhysxDynamicRigidBody dynamicActor:
                    ...
                    (dynamicActor.OwningComponent as IRuntimePhysicsStepListener)?.OnPhysicsStepped();
                    break;
        ...
        public void AddActor(PhysxActor actor)
        {
            ...
            {
                RuntimeThreadServices.Current.EnqueuePhysicsThread(() => AddActorNow(actor));
                return;
            }
        ...
        public void AddActors(PhysxActor[] actors)
        {
            if (!RuntimePhysicsServices.Current.IsPhysicsThread)
            {
                ...
                RuntimeThreadServices.Current.EnqueuePhysicsThread(() => AddActorsNow(actors));
                return;
            }
        ...
        public void RemoveActor(PhysxActor actor, bool wakeOnLostTouch = false)
        {
            if (!RuntimePhysicsServices.Current.IsPhysicsThread)
            {
                RuntimeThreadServices.Current.EnqueuePhysicsThread(() => RemoveActorNow(actor, wakeOnLostTouch));
                return;
            }
        ...
        public void RemoveActors(PhysxActor[] actors, bool wakeOnLostTouch = false)
        {
            if (!RuntimePhysicsServices.Current.IsPhysicsThread)
            {
                RuntimeThreadServices.Current.EnqueuePhysicsThread(() => RemoveActorsNow(actors, wakeOnLostTouch));
                return;
            }
        ...
        {
            RuntimePhysicsServices.Current.VisualizeSettings.PropertyChanged += PhysicsVisualizeSettings_PropertyChanged;
        ...
        {
            PhysicsVisualizeSettings s = RuntimePhysicsServices.Current.VisualizeSettings;
        ...
        private void PhysicsVisualizeSettings_PropertyChanged(object? sender, IXRPropertyChangedEventArgs e)
        {
            ...
            {
                case nameof(PhysicsVisualizeSettings.VisualizeEnabled):
                    VisualizeEnabled = settings.VisualizeEnabled;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeWorldAxes):
                    VisualizeWorldAxes = settings.VisualizeWorldAxes;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeBodyAxes):
                    VisualizeBodyAxes = settings.VisualizeBodyAxes;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeBodyMassAxes):
                    VisualizeBodyMassAxes = settings.VisualizeBodyMassAxes;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeBodyLinearVelocity):
                    VisualizeBodyLinearVelocity = settings.VisualizeBodyLinearVelocity;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeBodyAngularVelocity):
                    VisualizeBodyAngularVelocity = settings.VisualizeBodyAngularVelocity;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeContactPoint):
                    VisualizeContactPoint = settings.VisualizeContactPoint;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeContactNormal):
                    VisualizeContactNormal = settings.VisualizeContactNormal;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeContactError):
                    VisualizeContactError = settings.VisualizeContactError;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeContactForce):
                    VisualizeContactForce = settings.VisualizeContactForce;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeActorAxes):
                    VisualizeActorAxes = settings.VisualizeActorAxes;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionAabbs):
                    VisualizeCollisionAabbs = settings.VisualizeCollisionAabbs;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionShapes):
                    VisualizeCollisionShapes = settings.VisualizeCollisionShapes;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionAxes):
                    VisualizeCollisionAxes = settings.VisualizeCollisionAxes;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionCompounds):
                    VisualizeCollisionCompounds = settings.VisualizeCollisionCompounds;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionFaceNormals):
                    VisualizeCollisionFaceNormals = settings.VisualizeCollisionFaceNormals;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionEdges):
                    VisualizeCollisionEdges = settings.VisualizeCollisionEdges;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionStatic):
                    VisualizeCollisionStatic = settings.VisualizeCollisionStatic;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCollisionDynamic):
                    VisualizeCollisionDynamic = settings.VisualizeCollisionDynamic;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeJointLocalFrames):
                    VisualizeJointLocalFrames = settings.VisualizeJointLocalFrames;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeJointLimits):
                    VisualizeJointLimits = settings.VisualizeJointLimits;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeCullBox):
                    VisualizeCullBox = settings.VisualizeCullBox;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeMbpRegions):
                    VisualizeMbpRegions = settings.VisualizeMbpRegions;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeSimulationMesh):
                    VisualizeSimulationMesh = settings.VisualizeSimulationMesh;
                    break;
                case nameof(PhysicsVisualizeSettings.VisualizeSdf):
                    VisualizeSdf = settings.VisualizeSdf;
                    break;
            }
        }
