...
namespace XREngine.Scene
{
    ...
    public abstract class AbstractPhysicsScene : XRBase
    {
        ...
        /// <summary>
        /// Maps native joint handles to the owning <see cref="IPhysicsJointOwner"/>.
        /// Used by break-callback routing to find the component that owns a native joint.
        /// </summary>
        private readonly ConcurrentDictionary<IAbstractJoint, IPhysicsJointOwner> _jointComponentMap = new();

        /// <summary>
        /// Registers a component as the owner of a native joint. Called by <see cref="IPhysicsJointOwner"/> after joint creation.
        /// </summary>
        public void RegisterJointComponent(IAbstractJoint nativeJoint, IPhysicsJointOwner component)
        ...
        /// </summary>
        public IPhysicsJointOwner? FindJointComponent(IAbstractJoint nativeJoint)
