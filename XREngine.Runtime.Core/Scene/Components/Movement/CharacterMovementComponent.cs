...
namespace XREngine.Components.Movement
{
    ...
    public class CharacterMovement3DComponent : PlayerMovementComponentBase, IRuntimeCharacterMovementComponent
    {
        ...
        protected unsafe override void OnComponentActivated()
        {
            ...
            RuntimeCharacterMovementVisualizationServices.Current?.Attach(this);
        ...
        {
            RuntimeCharacterMovementVisualizationServices.Current?.Detach(this);
