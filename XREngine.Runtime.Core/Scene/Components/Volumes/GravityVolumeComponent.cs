...
namespace XREngine.Components.Scene.Volumes
{
    ...
    public class GravityVolumeComponent : TriggerVolumeComponent
    {
        ...
        private readonly Dictionary<IRuntimeDynamicRigidBodyComponent, bool> _affected = [];
        ...
        protected override void OnComponentDeactivated()
        {
            ...
            foreach ((IRuntimeDynamicRigidBodyComponent component, bool gravityEnabled) in _affected)
            {
        ...
        private void ApplyGravityTick()
        {
            ...
            foreach (IRuntimeDynamicRigidBodyComponent bodyComponent in _affected.Keys)
            {
