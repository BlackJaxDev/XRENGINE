...
namespace XREngine
{
    ...
    {
        private static IRuntimeDebugHostServices _current = new DefaultRuntimeDebugHostServices();

        public static IRuntimeDebugHostServices Current
        {
            get => _current;
            set => _current = value ?? new DefaultRuntimeDebugHostServices();
        }
    ...
    public class Debug
    {
        ...
        public static void LogWarning(ELogCategory category, int lineIgnoreCount, int includedLineCount, string message, params object[] args)
        {
            ...
            WriteLogMessage($"[WARN] {message}{Environment.NewLine}{stackTrace}", RuntimeDebugHostServices.Current.LogOutputToFile, category);
#endif
        }
        ...
        public static void LogException(ELogCategory category, Exception ex, string? message = null)
        {
            ...
            string logMessage = message != null
                ...
                : $"[EXCEPTION] {ex}";
            WriteLogMessage(logMessage, RuntimeDebugHostServices.Current.LogOutputToFile, category);
#endif
        }
        ...
        public static void LogError(ELogCategory category, string message, params object[] args)
        {
            ...
            WriteLogMessage($"[ERROR] {message}{Environment.NewLine}{stackTrace}", RuntimeDebugHostServices.Current.LogOutputToFile, category);
#endif
        }
...
#if DEBUG || EDITOR
            string stackTrace = GetStackTrace(4 + lineIgnoreCount, includedLineCount);
            WriteLogMessage($"[WARN] {message}{Environment.NewLine}{stackTrace}", RuntimeDebugHostServices.Current.LogOutputToFile, ELogCategory.General);
#endif
        }
    ...
    #if DEBUG || EDITOR
            string stackTrace = GetStackTrace(4 + lineIgnoreCount, includedLineCount);
            WriteLogMessage($"[ERROR] {message}{Environment.NewLine}{stackTrace}", RuntimeDebugHostServices.Current.LogOutputToFile, ELogCategory.General);
    #endif
        }
