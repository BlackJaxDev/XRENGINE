...
public sealed class YamlTransformReferenceAttribute : Attribute
{
}

public sealed class TransformYamlTypeInspector(ITypeInspector inner, bool applyReferenceOnRead) : ITypeInspector
{
