...
namespace XREngine
{
    ...
    {
        /// <summary>
        /// Application-level input access composed by Bootstrap.
        /// </summary>
        public static class Input
        {
            ...
            /// </summary>
            public static bool IsUIInputCaptured
                => XREngine.Runtime.InputIntegration.RuntimeInputCaptureServices.Current.IsUIInputCaptured;
            ...
            public static void SetUIInputCaptured(bool captured)
                => XREngine.Runtime.InputIntegration.RuntimeInputCaptureServices.Current.SetUIInputCaptured(captured);

            public static InputInterface? Get(ELocalPlayerIndex index)
                => XREngine.Input.RuntimePlayerControllerServices.Current?.GetLocalPlayer(index)?.InputDevice as InputInterface;
