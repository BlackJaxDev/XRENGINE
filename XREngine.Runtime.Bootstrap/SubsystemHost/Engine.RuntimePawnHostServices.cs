...
internal sealed class EngineRuntimePawnHostServices : IRuntimePawnHostServices, IDisposable
{
    ...
    public void Dispose()
    {
        foreach (OptionalInputRegistration registration in _optionalRegistrations.Values)
            registration.Dispose(null);
        _optionalRegistrations.Clear();
    }
