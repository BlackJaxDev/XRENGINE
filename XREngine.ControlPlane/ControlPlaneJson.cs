...
[JsonSerializable(typeof(WorldPackageStagingProgress), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerLaunch), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedClientLaunch), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerStartupConfiguration), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerResourceLimits), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerReport), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerDirective), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerFailure), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerMetrics), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedWorkerRosterEntry), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedAdmissionGrant), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ManagedAdmissionReservation), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ReserveManagedAdmissionRequest), GenerationMode = JsonSourceGenerationMode.Metadata)]
[JsonSerializable(typeof(ReserveManagedAdmissionResult), GenerationMode = JsonSourceGenerationMode.Metadata)]
