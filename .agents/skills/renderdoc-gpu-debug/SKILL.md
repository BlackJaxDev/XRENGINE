...
This is the core pattern for visual debugging. **Always export to PNG, then use Codex's Read tool to view the image.**
...
After exporting a PNG, **use the Read tool** to view it (Codex is multimodal):
