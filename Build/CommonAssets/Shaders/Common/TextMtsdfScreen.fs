...
void main()
{
    ...
    // MTSDF correction: combine multi-channel median with true SDF (alpha) using
    // Chlumsky's dual-clamp formula to suppress artifacts at corners and sharp features.
