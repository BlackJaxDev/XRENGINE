...
void main()
{
    ...
    vec4 start = ViewProjectionMatrix * vec4(vec3(LineData[idx], LineData[idx + 1], LineData[idx + 2]) + anchor, 1.0);
    vec4 end = ViewProjectionMatrix * vec4(vec3(LineData[idx + 3], LineData[idx + 4], LineData[idx + 5]) + anchor, 1.0);
