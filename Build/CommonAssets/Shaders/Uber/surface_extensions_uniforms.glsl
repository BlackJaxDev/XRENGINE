#ifndef XRENGINE_SURFACE_EXTENSIONS_UNIFORMS_GLSL
#define XRENGINE_SURFACE_EXTENSIONS_UNIFORMS_GLSL

// Native advanced-surface and repeated-layer runtime contract. Importers
// translate external material schemas into these engine-owned properties.

//@category("Advanced")
//@subcategory("Surface")
//@feature(id="surface-extensions", name="Surface Extensions", default=off, cost=medium)
//@depends("render-time")
...
//@feature(id="global-masks-themes", name="Global Masks And Themes", default=off, cost=medium)
//@depends("surface-extensions")
#ifndef XRENGINE_UBER_DISABLE_GLOBAL_MASKS_THEMES
...
//@property(name="_ColorMaskTexture", display="RGBA Color Mask", slot=texture, semantic=mask)
uniform sampler2D _ColorMaskTexture;
//@property(name="_ColorMaskEnabled", display="RGBA Color Mask Enabled", mode=static, default="0")
uniform float _ColorMaskEnabled;
...
//@feature(id="advanced-stylized-lighting", name="Advanced Stylized Lighting", default=off, cost=high)
...
//@feature(id="advanced-pbr", name="Advanced PBR And Reflections", default=off, cost=high)
//@depends("advanced-stylized-lighting", "advanced-specular")
#ifndef XRENGINE_UBER_DISABLE_ADVANCED_PBR
...
//@feature(id="layered-matcap-rim", name="Layered Matcap And Rim", default=off, cost=high)
//@depends("global-masks-themes")
...
//@category("Advanced")
//@subcategory("Decals")
//@feature(id="layered-decals", name="Layered Decals", default=off, cost=high)
//@depends("global-masks-themes", "render-time")
...
//@feature(id="layered-emission", name="Layered Emission", default=off, cost=high)
//@depends("global-masks-themes", "render-time")
...
//@feature(id="texture-array-flipbook", name="Texture Array Flipbook", default=off, cost=medium)
//@depends("global-masks-themes", "render-time")
