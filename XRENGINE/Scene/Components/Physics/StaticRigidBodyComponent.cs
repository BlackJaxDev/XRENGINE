    ...
    public class StaticRigidBodyComponent : PhysicsActorComponent
    {
        ...
        private void TryScheduleAutoGeneratedConvexColliders()
        {
            ...
            Engine.AddSwapCoroutine(() =>
            {
                ...
                var pendingModelComponent = GetSiblingComponent<ModelComponent>();
        ...
        private async Task GenerateAndAttachAutoGeneratedConvexCollidersAsync()
        {
            try
            {
                ...
                IReadOnlyList<PhysxConvexMesh> convexMeshes = await CreatePhysxConvexMeshesAsync(cancellationToken: default).ConfigureAwait(false);
