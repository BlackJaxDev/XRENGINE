    ...
    public class StaticRigidBodyComponent : PhysicsActorComponent
    {
        ...
        private async Task GenerateAndAttachAutoGeneratedConvexCollidersAsync()
        {
            ...
            try
            {
                ...
                ConvexHullInputCollection? inputCollection = modelComponent is not null
                    ? ConvexHullUtility.CollectCollisionInputCollection(modelComponent)
                    : null;
                string colliderLabel = GetAutoGeneratedColliderDebugLabel(modelComponent);
            ...
            catch (Exception ex)
            {
                ...
                Debug.PhysicsException(ex, $"Failed to auto-generate convex colliders for {GetAutoGeneratedColliderDebugLabel(ResolveModelComponentForColliders())}.");
            }
        }
        ...
        private string GetAutoGeneratedColliderDebugLabel(ModelComponent? modelComponent)
        {
