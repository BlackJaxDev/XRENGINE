...
public static partial class Engine
{
    ...
    private static RenderStatsPacket? CollectRenderStats()
    {
        ...
        return new RenderStatsPacket
        {
            ...
            ForbiddenGpuFallbackEvents = Rendering.Stats.ForbiddenGpuFallbackEvents,
            GpuMappedBuffers = Rendering.Stats.GpuMappedBuffers,
            GpuReadbackBytes = Rendering.Stats.GpuReadbackBytes,
            ...
            GpuMeshletRequestedFrames = Rendering.Stats.GpuMeshletRequestedFrames,
            GpuMeshletProductionFrames = Rendering.Stats.GpuMeshletProductionFrames,
            GpuMeshletFallbackFrames = Rendering.Stats.GpuMeshletFallbackFrames,
            GpuMeshletDispatchSkipped = Rendering.Stats.GpuMeshletDispatchSkipped,
            GpuMeshletTaskRecordsEmitted = Rendering.Stats.GpuMeshletTaskRecordsEmitted,
            GpuMeshletTaskRecordsFrustumCulled = Rendering.Stats.GpuMeshletTaskRecordsFrustumCulled,
            GpuMeshletTaskRecordsConeCulled = Rendering.Stats.GpuMeshletTaskRecordsConeCulled,
            GpuMeshletTaskRecordsHiZCulled = Rendering.Stats.GpuMeshletTaskRecordsHiZCulled,
            GpuMeshletExpansionOverflowCount = Rendering.Stats.GpuMeshletExpansionOverflowCount,
            GpuMeshletBufferBytesResident = Rendering.Stats.GpuMeshletBufferBytesResident,
            GpuMeshletCacheHits = Rendering.Stats.GpuMeshletCacheHits,
            GpuMeshletCacheMisses = Rendering.Stats.GpuMeshletCacheMisses,
            GpuMeshletCacheStale = Rendering.Stats.GpuMeshletCacheStale,
            ...
            VrLeftEyeDraws = Rendering.Stats.VrLeftEyeDraws,
            VrRightEyeDraws = Rendering.Stats.VrRightEyeDraws,
            VrLeftEyeVisible = Rendering.Stats.VrLeftEyeVisible,
            VrRightEyeVisible = Rendering.Stats.VrRightEyeVisible,
            VrLeftWorkerBuildTimeMs = Rendering.Stats.VrLeftWorkerBuildTimeMs,
            VrRightWorkerBuildTimeMs = Rendering.Stats.VrRightWorkerBuildTimeMs,
            VrRenderSubmitTimeMs = Rendering.Stats.VrRenderSubmitTimeMs,
            VrXrWaitFrameBlockTimeMs = Rendering.Stats.VrXrWaitFrameBlockTimeMs,
            VrXrEndFrameSubmitTimeMs = Rendering.Stats.VrXrEndFrameSubmitTimeMs,
            VrXrPredictedToLatePoseDeltaMillimeters = Rendering.Stats.VrXrPredictedToLatePoseDeltaMillimeters,
            VrXrPredictedToLatePoseDeltaDegrees = Rendering.Stats.VrXrPredictedToLatePoseDeltaDegrees,
            VrXrPredictedDisplayLeadTimeMs = Rendering.Stats.VrXrPredictedDisplayLeadTimeMs,
            VrXrMissedDeadlineFrames = Rendering.Stats.VrXrMissedDeadlineFrames,
            VrXrTrackingLossFrames = Rendering.Stats.VrXrTrackingLossFrames,
            VrXrRelocatePredictedTimeMs = Rendering.Stats.VrXrRelocatePredictedTimeMs,
            VrXrCollectFrustumExpansionDegrees = Rendering.Stats.VrXrCollectFrustumExpansionDegrees,
            VrXrPacingThreadIdleTimeMs = Rendering.Stats.VrXrPacingThreadIdleTimeMs,
            VrXrPacingHandoffStalls = Rendering.Stats.VrXrPacingHandoffStalls,
