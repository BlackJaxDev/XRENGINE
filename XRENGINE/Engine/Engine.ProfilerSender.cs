...
public static partial class Engine
{
    ...
    private static RenderStatsPacket? CollectRenderStats()
    {
        ...
        var churnRowsSnapshot = RuntimeEngine.Rendering.Stats.ResourceChurn.GetLastFrameRows();
        ...
        return new RenderStatsPacket
        {
            ...
            RenderProfilerV2 = new RenderProfilerV2Data
            {
                RendererState = new RenderProfilerRendererStateData
                {
                    ...
                    DirectionalCascadeStaleSampled = RuntimeEngine.Rendering.Stats.RendererState.DirectionalCascadeStaleSampled,
                    DirectionalCascadeMixedGenerationPrevented = RuntimeEngine.Rendering.Stats.RendererState.DirectionalCascadeMixedGenerationPrevented,
                    DirectionalCascadePhysicalReprojected = RuntimeEngine.Rendering.Stats.RendererState.DirectionalCascadePhysicalReprojected,
                    DirectionalCascadeForcedFreshRender = RuntimeEngine.Rendering.Stats.RendererState.DirectionalCascadeForcedFreshRender,
            ...
            VulkanDriverPipelineCachePersistedHits = RuntimeEngine.Rendering.Stats.Vulkan.VulkanDriverPipelineCachePersistedHits,
            VulkanDriverPipelineCacheRuntimeHits = RuntimeEngine.Rendering.Stats.Vulkan.VulkanDriverPipelineCacheRuntimeHits,
            VulkanDriverPipelineCacheMisses = RuntimeEngine.Rendering.Stats.Vulkan.VulkanDriverPipelineCacheMisses,
            VulkanDriverPipelineCacheUnknown = RuntimeEngine.Rendering.Stats.Vulkan.VulkanDriverPipelineCacheUnknown,
            VulkanPipelineCompileRequiredCount = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineCompileRequiredCount,
            VulkanPipelineCompileCompletedCount = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineCompileCompletedCount,
            VulkanPipelineBackgroundCompileCompletedCount = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineBackgroundCompileCompletedCount,
            VulkanPipelineCompileTotalMs = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineCompileTotalMs,
            VulkanPipelineCompileMaxMs = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineCompileMaxMs,
            VulkanPipelineAsyncQueuedCount = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineAsyncQueuedCount,
            VulkanPipelineQueueRejectedCount = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineQueueRejectedCount,
            VulkanPipelineDrawNotReadyCount = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineDrawNotReadyCount,
            VulkanPipelineQueueDepthHighWater = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineQueueDepthHighWater,
            VulkanPipelineQueueCapacity = RuntimeEngine.Rendering.Stats.Vulkan.VulkanPipelineQueueCapacity,
            ...
            VulkanFrameLoop = new VulkanFrameLoopTelemetryData
            {
                ...
                CommandChainWorkerQueuedChains = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerQueuedChains,
                CommandChainWorkersStarted = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkersStarted,
                CommandChainWorkersCompleted = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkersCompleted,
                CommandChainSeriallyRecorded = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainSeriallyRecorded,
                CommandChainWorkerReused = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerReused,
                CommandChainWorkerConflicts = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerConflicts,
                CommandChainWorkerFailures = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerFailures,
                CommandChainWorkerWaitTimeouts = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerWaitTimeouts,
                CommandChainPeakConcurrentWorkers = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainPeakConcurrentWorkers,
                CommandChainWorkerQueueDelayMs = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerQueueDelayMs,
                CommandChainWorkerRecordMs = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerRecordMs,
                CommandChainWorkerActiveSpanMs = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerActiveSpanMs,
                CommandChainWorkerOverlapMs = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerOverlapMs,
                CommandChainWorkerMergeMs = RuntimeEngine.Rendering.Stats.Vulkan.VulkanCommandChainWorkerMergeMs,
            ...
            FrameLifecycle = new FrameLifecycleTelemetryData
            {
                ...
                RequestedCollectGeneration = RuntimeEngine.Rendering.Stats.FrameLifecycle.RequestedCollectGeneration,
                CompletedCollectGeneration = RuntimeEngine.Rendering.Stats.FrameLifecycle.CompletedCollectGeneration,
                PublishedCollectGeneration = RuntimeEngine.Rendering.Stats.FrameLifecycle.PublishedCollectGeneration,
                ConsumedCollectGeneration = RuntimeEngine.Rendering.Stats.FrameLifecycle.ConsumedCollectGeneration,
                RequiredCollectGeneration = RuntimeEngine.Rendering.Stats.FrameLifecycle.RequiredCollectGeneration,
            ...
            RenderResourceCreatedCount = RuntimeEngine.Rendering.Stats.ResourceChurn.CreatedCount,
            RenderResourceRecreatedCount = RuntimeEngine.Rendering.Stats.ResourceChurn.RecreatedCount,
            RenderResourceResizedCount = RuntimeEngine.Rendering.Stats.ResourceChurn.ResizedCount,
            RenderResourceDestroyedCount = RuntimeEngine.Rendering.Stats.ResourceChurn.DestroyedCount,
