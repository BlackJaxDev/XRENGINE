        ...
        public static partial class Rendering
        {
            public static partial class Stats
            {
                public static class GpuTransparency
                {
                    ...
                    {
                        _lastFrameGpuTransparencyOpaqueOrOtherVisible = Interlocked.Exchange(ref _gpuTransparencyOpaqueOrOtherVisible, 0);
                        _lastFrameGpuTransparencyMaskedVisible = Interlocked.Exchange(ref _gpuTransparencyMaskedVisible, 0);
                        _lastFrameGpuTransparencyApproximateVisible = Interlocked.Exchange(ref _gpuTransparencyApproximateVisible, 0);
                        _lastFrameGpuTransparencyExactVisible = Interlocked.Exchange(ref _gpuTransparencyExactVisible, 0);
                    }
