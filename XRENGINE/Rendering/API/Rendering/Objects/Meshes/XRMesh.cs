...
//        public bool PopulateIndexBuffer(EPrimitiveType type, XRDataBuffer buffer, IndexSize bufferElementSize)
//        {
//            //using var t = Engine.Profiler.Start("XRMesh PopulateIndexBuffer");
...
//            if (bufferElementSize == IndexSize.Byte)
//                buffer.SetDataRaw(indices.Select(x => (byte)x), indices.Length);
//            else if (bufferElementSize == IndexSize.TwoBytes)
