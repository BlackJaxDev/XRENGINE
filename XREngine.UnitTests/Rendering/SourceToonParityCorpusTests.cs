...
[TestFixture]
public sealed class SourceToonParityCorpusTests
{
    ...
    public void Corpus_MetadataAndLicense_ArePinnedForEveryMaterial()
    {
        ...
        root.GetProperty("poiyomiVersion").GetString().ShouldBe(SourceToon93Catalog.VersionText);
        root.GetProperty("poiyomiCommit").GetString().ShouldBe(SourceToon93Catalog.RepositoryCommit);
    ...
    [Test]
    public void SourceReferenceImages_ArePinnedLicensedAndMatchManifestCameraCount()
    {
