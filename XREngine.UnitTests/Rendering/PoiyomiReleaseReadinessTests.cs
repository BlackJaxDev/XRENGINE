...
[TestFixture]
public sealed class PoiyomiReleaseReadinessTests
{
    [Test]
    public void PublicSupportStatementMatchesExecutableCatalogAndDiagnostics()
    {
        ...
        guide.ShouldContain($"Poiyomi Toon {PoiyomiToon93Catalog.VersionText}");
        guide.ShouldContain(PoiyomiToon93Catalog.RepositoryCommit);
    ...
    [Test]
    public void PoiyomiArtifactsUseFeatureOrientedNames()
    {
    ...
    private static JsonDocument OpenCatalog()
        => JsonDocument.Parse(PoiyomiToon93Catalog.OpenCatalog());

    private static string FindRepositoryFile(params string[] segments)
        => PoiyomiParityCorpusTests.FindRepositoryFile(segments);
}
