...
public sealed class GpuBvhFrustumParityIntegrationTests : GpuTestBase
{
    ...
    private const int StatsUInts = (int)global::XREngine.Rendering.GpuStatsLayout.FieldCount;
        ...
        uint? workgroupCount = null)
    {
        ...
        try
        {
            ...
            return new(
                ...
                perViewIds,
                overflowResult[0],
                statsResult[(int)global::XREngine.Rendering.GpuStatsLayout.BvhQueueOverflows]);
        }
        finally
        {
