...
[TestFixture]
[NonParallelizable]
public sealed class SourceToonInspectorInteractionTests
{
    ...
    private SourceToonInspectorInteractionHarness _harness = null!;
    ...
    public void SetUp()
    {
        ...
        _schema = SourceToonAuthoringSchemaCatalog.GetOrCreate(
    ...
    public void RestartPersistsDurableStateButNotTransientPreviewState()
    {
        ...
        SourceToonInspectorInteractionHarness restored = new(_schema, _material);
