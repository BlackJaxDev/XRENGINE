...
[TestFixture]
[NonParallelizable]
public sealed class UberShaderCompilationTests
{
    ...
    [
        ...
        "flipbook", "subsurface", "dissolve", "parallax", "surface-extensions",
        "global-masks-themes", "advanced-stylized-lighting", "advanced-pbr",
        "layered-matcap-rim", "layered-decals", "layered-emission",
        "texture-array-flipbook", "extended-effects", "vertex-effects",
        "audiolink", "environment-lighting", "view-context",
    ];
    ...
    public void RepresentativeVariants_CompileToWarningFreeSpirv(string profile)
    {
        string[] features = profile switch
        {
            ...
            [
                ...
                "layered-decals", "extended-effects", "vertex-effects",
            ],
            _ => FeatureUniverse,
        };
    ...
    public void PassPermutationContractsCoverAllRequiredSemanticPasses()
    {
        ...
        foreach (string file in shaderFiles)
            File.Exists(FindRepositoryFile(
    ...
    public void OpenGlAndVulkanPathsResolveTheSameFeatureSourceContract()
    {
        ...
        openGlSource.ResolvedSource.ShouldContain("uberApplySurfaceEffects");
        vulkan.RewrittenSource.ShouldContain("uberApplySurfaceEffects");
        ...
        openGlSource.MacroSummary.Defines.ShouldContain("XRENGINE_EXTENDED_EFFECTS_GLSL");
    }
    ...
    [Test]
    public void GeneratedVertexShader_VertexEffectDeclarationsAreGlobalAndCompileWarningFree()
    {
        XRMesh mesh = new(
            [
        ...
        source.IndexOf("uniform float _VertexEffectsEnabled;", StringComparison.Ordinal).ShouldBeLessThan(mainIndex);
        source.LastIndexOf("uniform float _VertexEffectsEnabled;", StringComparison.Ordinal)
            .ShouldBe(source.IndexOf("uniform float _VertexEffectsEnabled;", StringComparison.Ordinal));
