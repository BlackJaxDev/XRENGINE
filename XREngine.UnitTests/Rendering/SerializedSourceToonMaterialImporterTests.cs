...
[TestFixture]
[NonParallelizable]
public sealed class SerializedSourceToonMaterialImporterTests
{
    ...
    [Test]
    public void ImportWithReport_SourceToon93_MapsMaterialToUberShader()
    {
        ...
        string mainTexPath = CreateSourceAsset(projectRoot, "Assets/Textures/body.png", "11111111111111111111111111111111");
        string normalPath = CreateSourceAsset(projectRoot, "Assets/Textures/body_normal.png", "22222222222222222222222222222222");
        string alphaPath = CreateSourceAsset(projectRoot, "Assets/Textures/body_alpha.png", "33333333333333333333333333333333");
        string emissionPath = CreateSourceAsset(projectRoot, "Assets/Textures/body_emission.png", "44444444444444444444444444444444");
        string matcapPath = CreateSourceAsset(projectRoot, "Assets/Textures/body_matcap.png", "55555555555555555555555555555555");
        ...
        WriteSourceMeta(shaderPath, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
...
""");
        ...
        SerializedMaterialImportResult result = SerializedMaterialImporter.ImportWithReport(materialPath, projectRoot);

        result.IsSourceToon.ShouldBeTrue(
    ...
    [Test]
    public void ImportWithReport_SourceToon93_ExplicitDisabledFeaturesIgnoreDormantTextures()
    {
        ...
        CreateSourceAsset(projectRoot, "Assets/Textures/body_emission.png", "44444444444444444444444444444444");
        CreateSourceAsset(projectRoot, "Assets/Textures/body_matcap.png", "55555555555555555555555555555555");
...
""");
        ...
        XRMaterial material = SerializedMaterialImporter.ImportWithReport(materialPath, projectRoot).Material.ShouldNotBeNull();
    ...
    public void ImportWithReport_LilToonCutout_MapsMaterialToUberShader()
    {
        ...
        string mainTexPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body.png", "61111111111111111111111111111111");
        string normalPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body_normal.png", "62222222222222222222222222222222");
        string alphaPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body_alpha.png", "63333333333333333333333333333333");
        string emissionPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body_emission.png", "64444444444444444444444444444444");
        string matcapPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body_matcap.png", "65555555555555555555555555555555");
        string rimPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body_rim.png", "66666666666666666666666666666666");
        string shadowPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body_shadow.png", "67777777777777777777777777777777");
        string parallaxPath = CreateSourceAsset(projectRoot, "Assets/Textures/lil_body_height.png", "68888888888888888888888888888888");

        Directory.CreateDirectory(Path.GetDirectoryName(shaderPath)!);
        File.WriteAllText(shaderPath, "Shader \"Hidden/lilToonCutout\" { _lilToonVersion (\"Version\", Int) = 45 }\n");
        WriteSourceMeta(shaderPath, "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb");
...
""");
        ...
        result.IsSourceToon.ShouldBeFalse();
    ...
    private static string CreateSourceAsset(string projectRoot, string relativePath, string guid)
    {
        string path = Path.Combine(projectRoot, relativePath.Replace('/', Path.DirectorySeparatorChar));
        Directory.CreateDirectory(Path.GetDirectoryName(path)!);
        File.WriteAllBytes(path, []);
        WriteSourceMeta(path, guid);
        return path;
    }

    private static void WriteSourceMeta(string assetPath, string guid)
