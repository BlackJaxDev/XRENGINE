...
[TestFixture]
[NonParallelizable]
public sealed class SourceToonVisualPerformanceTests
{
    ...
    public void SetUp()
    {
        ...
        _corpus = JsonDocument.Parse(File.ReadAllText(SourceToonParityCorpusTests.FindRepositoryFile(
    ...
    public void VisualEnvironmentAndOutputMatrixArePinnedAndCameraDependent()
    {
        ...
        JsonElement sourceReference = visual.GetProperty("unityReference");
        sourceReference.GetProperty("shaderName").GetString().ShouldBe(".poiyomi/Poiyomi Toon");
        sourceReference.GetProperty("captureWidth").GetInt32().ShouldBe(640);
        sourceReference.GetProperty("captureHeight").GetInt32().ShouldBe(360);
        sourceReference.GetProperty("cameraLookAt").GetArrayLength().ShouldBe(3);
        ...
        string unitWorld = SourceToonParityCorpusTests.FindRepositoryFile(
    ...
    {
        string path = SourceToonParityCorpusTests.FindRepositoryFile(
    ...
    public void ImportSchemaVariantAndInspectorBudgetsAreMeasuredAndMet()
    {
        ...
        ShaderAuthoringSchema schema = SourceToonAuthoringSchemaCatalog.GetOrCreate(
        ...
        SourceToonInspectorInteractionHarness harness = new(schema, material);
        timer.Restart();
