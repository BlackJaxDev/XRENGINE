...
[TestFixture]
[NonParallelizable]
public sealed class PoiyomiPhase810ContractTests
{
    ...
    [Test]
    public void Manifest_DeclaresPhase810FeatureFamilies()
    {
    ...
    public void CanonicalShaders_KeepEffectsAndDeformationsPassEquivalent()
    {
        ...
        fragment.ShouldContain("poiApplyPhase8Coverage(mesh)");
        fragment.ShouldContain("poiApplyPhase8Surface(mesh");
        fragment.ShouldContain("poiApplyPhase8Post(mesh");
