...
[TestFixture]
public sealed class SerializedMaterialAnimationImporterTests
{
    [Test]
...
""";
        ...
        SerializedMaterialAnimationBinding color = clip.SourceMaterialBindings
            .Single(x => x.SourceProperty == "_Color");
        color.MaterialSlot.ShouldBe(0);
        color.Component.ShouldBe(0);
        color.ValueKind.ShouldBe(SerializedMaterialAnimationValueKind.Color);

        SerializedMaterialAnimationBinding locked = clip.SourceMaterialBindings
        ...
        SerializedMaterialAnimationBinding texture = clip.SourceMaterialBindings
