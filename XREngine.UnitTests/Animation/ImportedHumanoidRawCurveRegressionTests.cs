...
[TestFixture]
public sealed class ImportedHumanoidRawCurveRegressionTests
{
    [Test]
    public void ImportedSexyWalkHumanoidClip_ReplaysSourceRawCurvesAcrossWholeClip()
    {
        ...
        {
            ImportedHumanoidMuscleMap.TryGetValue(channel.Name, out EHumanoidValue humanoidValue).ShouldBeTrue($"Missing humanoid mapping for '{channel.Name}'.");
    ...
    private static ImportedHumanoidRawAuditFixture LoadFixture(string fixturePath)
    {
        string json = File.ReadAllText(fixturePath);
        return JsonSerializer.Deserialize<ImportedHumanoidRawAuditFixture>(json, new JsonSerializerOptions
        {
    ...
    private sealed class ImportedHumanoidRawAuditFixture
    {
        [JsonPropertyName("Channels")]
        public required List<ImportedHumanoidRawAuditChannel> Channels { get; init; }
    }

    private sealed class ImportedHumanoidRawAuditChannel
    {
        [JsonPropertyName("Name")]
        public required string Name { get; init; }

        [JsonPropertyName("Samples")]
        public required List<ImportedHumanoidRawAuditSample> Samples { get; init; }
    }

    private sealed class ImportedHumanoidRawAuditSample
    {
        [JsonPropertyName("t")]
