...
[TestFixture]
[NonParallelizable]
public sealed class SerializedSceneImporterTests
{
    private IDisposable? _sceneImportRegistration;
    private IDisposable? _sourceImportRegistration;

    [SetUp]
    public void SetUp()
    {
        _sceneImportRegistration = RuntimeSceneImportServices.Install(new EditorRuntimeSceneImportServices());
    ...
    public void TearDown()
    {
        ...
        _sceneImportRegistration?.Dispose();
        _sceneImportRegistration = null;
    }

    [Test]
    public void AssetManager_Load_SerializedScene_ImportsDirectHierarchyAndSceneRoots()
    {
        using var sandbox = new SourceImportSandbox();
...
""");
    ...
    [Test]
    public void AssetManager_Load_SerializedScene_ExpandsPrefabInstancesAndAppliesOverrides()
    {
        using var sandbox = new SourceImportSandbox();
...
""".Replace("__PREFAB_GUID__", prefabGuid, StringComparison.Ordinal));
    ...
    [Test]
    public void AssetManager_Load_SerializedScene_ImportsSupportedComponents()
    {
        using var sandbox = new SourceImportSandbox();
...
""".Replace("__MAT_GUID__", materialGuid, StringComparison.Ordinal));
    ...
    [Test]
    public void AssetManager_Load_SerializedPrefab_ImportsPrefabSourceAsset()
    {
        using var sandbox = new SourceImportSandbox();
...
""");
    ...
    [Test]
    public void AssetManager_Load_SerializedScene_AppliesPrefabAddRemoveDeltas()
    {
        using var sandbox = new SourceImportSandbox();
...
""".Replace("__PREFAB_GUID__", prefabGuid, StringComparison.Ordinal));
    ...
    private static AssetManager CreateAssetManager(SourceImportSandbox sandbox)
    {
    ...
    private sealed class SourceImportSandbox : IDisposable
    {
        public SourceImportSandbox()
        {
