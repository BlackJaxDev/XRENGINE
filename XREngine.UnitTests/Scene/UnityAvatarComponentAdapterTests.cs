...
[TestFixture]
[NonParallelizable]
public sealed class UnityAvatarComponentAdapterTests
{
    [Test]
    public void MonoBehaviourAdapters_MapPhysicsConstraintDescriptorAndPreserveUnsupportedMetadata()
    {
        ...
        UnityPrefabConversionResult conversion =
            UnitySceneImporter.ImportPrefabWithManifest(prefabPath);
        ...
        UnityTransformConstraintComponent constraint =
            root.Components.OfType<UnityTransformConstraintComponent>().Single();
        ...
        constraint.Channels.ShouldBe(
            UnityTransformConstraintChannels.PositionX |
            UnityTransformConstraintChannels.RotationY);
        UnityTransformConstraintSource constraintSource = constraint.Sources.Single();
        ...
        UnityAvatarDescriptorComponent descriptor =
            root.Components.OfType<UnityAvatarDescriptorComponent>().Single();
        descriptor.AvatarRoot.ShouldBeSameAs(root.Transform);
        descriptor.ViewPosition.ShouldBe(new Vector3(0.0f, 1.65f, -0.2f));
        descriptor.LipSyncMode.ShouldBe(UnityAvatarLipSyncMode.VisemeBlendShape);
