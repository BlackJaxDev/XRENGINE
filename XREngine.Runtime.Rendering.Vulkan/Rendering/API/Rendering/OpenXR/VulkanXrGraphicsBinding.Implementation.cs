...
Target:                 new RenderFrameViewTargetDescriptor(
        ...
        out OpenXrStereoRenderTarget target)
    {
        ...
        target = new OpenXrStereoRenderTarget(
            ...
            leftImageIndex,
            rightImageIndex,
            Context.PendingFrameNumber);
        return true;
    }

    private void EnsureOpenXrStereoViewport(uint width, uint height)
        => Context.EnsureOpenXrStereoViewport(width, height);
    ...
    private bool TryRenderVulkanEyesBatch(CompositionLayerProjectionView* projectionViews, out bool handled)
    {
        ...
        try
        {
            bool collectedTrueSinglePassStereo =
                Context.PendingFrameUsesTrueSinglePassStereo;
        ...
        out EOpenXrStrictSpsFaultInjectionStage injectedFailureStage)
    {
        ...
        using (new VulkanOpenXrRenderOperation(renderer))
        {
            ...
            Context.RecordOpenXrLastRenderedFrameId(renderFrameId);
