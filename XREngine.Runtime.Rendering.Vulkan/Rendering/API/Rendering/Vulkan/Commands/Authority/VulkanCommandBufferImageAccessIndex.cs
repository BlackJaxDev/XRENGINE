...
/// <summary>Tracks the latest image-access state recorded by one command buffer.</summary>
internal sealed class VulkanCommandBufferImageAccessIndex(int initialCapacity = 32)
{
    private readonly Dictionary<VulkanTrackedImageSubresource, VulkanImageAccessState> _states =
        new(initialCapacity);
