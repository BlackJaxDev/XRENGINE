...
namespace XREngine.Rendering.Vulkan
{
    ...
    /// </summary>
    internal ref struct CommandBufferLifecycleState
    {
        public CommandBufferLifecycleState(
            uint imageIndex,
            bool preserveSwapchainForOverlay,
            FramePlanBuilder framePlanBuilder)
        {
            this = default;
            ImageIndex = imageIndex;
            PreserveSwapchainForOverlay = preserveSwapchainForOverlay;
            FramePlanBuilder = framePlanBuilder ?? throw new ArgumentNullException(nameof(framePlanBuilder));
        ...
        public FramePlanBuilder FramePlanBuilder;
        ...
        public void SealFramePlan()
        {
            ...
            SealedFramePlan = FramePlanBuilder.BuildAndSeal(
