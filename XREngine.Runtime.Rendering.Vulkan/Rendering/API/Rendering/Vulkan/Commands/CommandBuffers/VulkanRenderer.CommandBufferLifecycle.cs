    ...
    public unsafe partial class VulkanRenderer
    {
            ...
            scoped ref CommandBufferLifecycleState state)
        {
                   ...
                   new(EVulkanCpuStage.FrameOpPreparation))
            {
                ...
                state.FrameOperations = _frameOperationScheduler.SortFrameOpsCore(
                    state.FrameOperations,
                    CompiledRenderGraph);
                ...
                VulkanPrimaryCommandPlan primaryPlan =
                    state.Scratch.PrimaryCommandPlan;
                primaryPlan.Build(
                    state.FrameOperations,
                    state.FrameOperationsSignature,
                ...
                primaryReuseIdentity.Add(state.FrameOperationsSignature);
