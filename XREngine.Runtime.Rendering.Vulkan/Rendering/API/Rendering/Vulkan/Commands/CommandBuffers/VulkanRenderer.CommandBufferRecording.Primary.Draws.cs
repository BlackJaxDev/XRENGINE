...
namespace XREngine.Rendering.Vulkan
{
    public unsafe partial class VulkanRenderer
    {
        ...
        private int GetMeshDrawUniformSlot(scoped ref PrimaryCommandBufferRecordingState recordingState,
            int opIndex,
        ...
        private bool RecordMeshDrawIntoCommandBuffer(scoped ref PrimaryCommandBufferRecordingState recordingState,
        ...
        private void RecordIndirectDrawIntoCommandBuffer(scoped ref PrimaryCommandBufferRecordingState recordingState,
            CommandBuffer targetCommandBuffer,
        ...
        {
            if (drawOp.PassIndex == int.MinValue && recordingState.ActivePassIndex != int.MinValue)
                return recordingState.ActivePassIndex;
        ...
        private int CountContiguousMeshCommandChainRun(scoped ref PrimaryCommandBufferRecordingState recordingState, int startIndex, MeshDrawOp firstDraw, int passIndex)
        {
            int count = 0;
        ...
        private int CountContiguousIndirectCommandChainRun(scoped ref PrimaryCommandBufferRecordingState recordingState, int startIndex, IndirectDrawOp firstDraw, int passIndex)
        {
            int count = 0;
            for (int i = startIndex; i < recordingState.Ops.Length; i++)
            {
        ...
        private void EmitIndirectDrawRunReadBarrier(scoped ref PrimaryCommandBufferRecordingState recordingState)
        {
