...
internal sealed class VulkanFrameOpPlannerStateKeyComparer : IEqualityComparer<VulkanFrameOpPlannerStateKey>
{
    public static VulkanFrameOpPlannerStateKeyComparer Instance { get; } = new();

    public bool Equals(VulkanFrameOpPlannerStateKey x, VulkanFrameOpPlannerStateKey y)
        => x.ContextKind == y.ContextKind &&
           ...
           x.ResourceRegistryInstanceRevision == y.ResourceRegistryInstanceRevision &&
    ...
    public int GetHashCode(VulkanFrameOpPlannerStateKey value)
    {
        unchecked
        {
            ...
            hash = (hash * 397) ^ value.ResourceRegistryInstanceRevision;
