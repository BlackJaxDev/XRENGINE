...
internal sealed class VulkanFinalPresentationLedgerState
{
        ...
        bool writeSucceeded)
    {
        lock (_sync)
        {
            ...
            // Preparation-only refreshes have no command artifact. Do not let a
            // later preflight observation erase the exact secondary/primary that
            // already established the same native descriptor payload this frame.
            if (commandBuffer == 0 &&
