...
internal sealed unsafe partial class VulkanFrameLoop
{
        ...
        string phase)
    {
        ...
        Viewport expectedViewport = VulkanCommandRuntime.CreateVulkanViewport(extent);
    ...
    internal bool TryRefreshFrameOpResourceWrappers(
        FrameOp[] ops,
        FrameOpContext plannerContext,
        string reason,
        bool allowSynchronousUpload,
        out string failureReason)
    {
        ...
        HashSet<object> visitedRegistries = _commandRuntime.CommandBuffers.RecordingScratch.Value!.VisitedResourceRegistries;
        ...
        bool sealFrameManifest = false)
    {
        ...
        CommandBufferRecordingScratch recordingScratch = _commandRuntime.CommandBuffers.RecordingScratch.Value!;
    ...
    private VulkanOpenXrResourcePlannerThreadData CreateOpenXrResourcePlannerThreadData()
    {
        ...
        VulkanOpenXrResourcePlannerSessionToken session = new(
            backend.CurrentThreadExecutionState,
            backend.ResourcePlannerStatesLock,
            OpenXrResourcePlannerStates,
            _framePlanner.GetPublishedResourcePlannerGeneration().State.ResourcePlannerRevision);
        return new(
            session,
            _commandRuntime.ThreadWorkspace.Current,
            _commandRuntime);
    }

    private VulkanOpenXrThreadRenderStateData CreateOpenXrThreadRenderStateData()
        => new(_commandRuntime.ThreadWorkspace.Current, _commandRuntime);
