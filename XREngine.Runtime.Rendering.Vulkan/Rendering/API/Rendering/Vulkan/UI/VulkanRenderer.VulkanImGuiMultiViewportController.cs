...
public unsafe partial class VulkanRenderer
{
    ...
    internal sealed unsafe class VulkanImGuiMultiViewportController : IRendererImGuiViewportCallbacks, IDisposable
    {
        ...
        private VulkanImGuiMultiViewportController(VulkanRenderer renderer, nint context)
        {
            _renderer = renderer;
            _context = context;
        ...
        public static VulkanImGuiMultiViewportController? TryCreate(VulkanRenderer renderer, nint context)
        {
            ...
            if (!renderer.TargetRequiresSwapchainOutput || renderer.XRWindow.Window.VkSurface is null)
            {
            ...
            return new VulkanImGuiMultiViewportController(renderer, context);
        }
        ...
        private void PlatformCreateWindow(ImGuiViewport* nativeViewport)
        {
            try
            {
                ...
                VulkanImGuiPlatformWindow window = new(this, _renderer, viewport);
        ...
        private byte PlatformGetWindowFocus(ImGuiViewport* nativeViewport)
        {
            try
            {
                ...
                return (window?.Focused ?? _renderer.XRWindow.IsFocused) ? (byte)1 : (byte)0;
            }
            catch (Exception ex)
            {
